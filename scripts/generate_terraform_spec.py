...
# =============================================================================
# Typed Resource Allowlist (Removed in 1.1)
# =============================================================================
# Typed connector-specific resources (e.g., airbyte_source_postgres) were
# deprecated in 1.0 and have been removed in 1.1. All connectors are now
# managed exclusively via the generic airbyte_source / airbyte_destination
# resources and the airbyte_connector_configuration data source.
#
# The allowlists below are kept as empty sets. Setting them to non-empty
# would re-enable typed resource generation for those connectors.

TYPED_SOURCE_ALLOWLIST: set[str] = set()

TYPED_DESTINATION_ALLOWLIST: set[str] = set()

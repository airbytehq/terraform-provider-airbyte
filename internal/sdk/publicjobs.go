...
func newPublicJobs(sdkConfig sdkConfiguration) *PublicJobs {
	return &PublicJobs{
...
func (s *PublicJobs) CancelJob(ctx context.Context, request operations.CancelJobRequest) (*operations.CancelJobResponse, error) {
...
func (s *PublicJobs) CreateJob(ctx context.Context, request shared.JobCreateRequest) (*operations.CreateJobResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *PublicJobs) GetJob(ctx context.Context, request operations.GetJobRequest) (*operations.GetJobResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
		OperationID:    "getJob",
		OAuth2Scopes:   []string{},
...
func (s *PublicJobs) ListJobs(ctx context.Context, request operations.ListJobsRequest) (*operations.ListJobsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,

...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.858.2
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "1.0.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 1.0.1 2.858.2 1.0.0 github.com/airbytehq/terraform-provider-airbyte/internal/sdk",

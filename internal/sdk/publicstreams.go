...
func newPublicStreams(sdkConfig sdkConfiguration) *PublicStreams {
...
func (s *PublicStreams) GetStreamProperties(ctx context.Context, request operations.GetStreamPropertiesRequest) (*operations.GetStreamPropertiesResponse, error) {

...
func (u *SourceGoogleAnalyticsV4ServiceAccountOnlyUpdateCredentials) UnmarshalJSON(data []byte) error {
	...
	sourceGoogleAnalyticsV4ServiceAccountOnlyUpdateServiceAccountKeyAuthentication := new(SourceGoogleAnalyticsV4ServiceAccountOnlyUpdateServiceAccountKeyAuthentication)

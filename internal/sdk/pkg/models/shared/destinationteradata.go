...
func (u *DestinationTeradataSSLModes) UnmarshalJSON(data []byte) error {
	...
	destinationTeradataDisable := new(DestinationTeradataDisable)
	...
	destinationTeradataAllow := new(DestinationTeradataAllow)
	...
	destinationTeradataPrefer := new(DestinationTeradataPrefer)
	...
	destinationTeradataRequire := new(DestinationTeradataRequire)
	...
	destinationTeradataVerifyCa := new(DestinationTeradataVerifyCa)
	...
	destinationTeradataVerifyFull := new(DestinationTeradataVerifyFull)

...
// DestinationPulsarUpdateCompressionType - Compression type for the producer.
type DestinationPulsarUpdateCompressionType string

const (
	DestinationPulsarUpdateCompressionTypeNone   DestinationPulsarUpdateCompressionType = "NONE"
	DestinationPulsarUpdateCompressionTypeLz4    DestinationPulsarUpdateCompressionType = "LZ4"
	DestinationPulsarUpdateCompressionTypeZlib   DestinationPulsarUpdateCompressionType = "ZLIB"
	DestinationPulsarUpdateCompressionTypeZstd   DestinationPulsarUpdateCompressionType = "ZSTD"
	DestinationPulsarUpdateCompressionTypeSnappy DestinationPulsarUpdateCompressionType = "SNAPPY"
)

func (e DestinationPulsarUpdateCompressionType) ToPointer() *DestinationPulsarUpdateCompressionType {
	return &e
}

func (e *DestinationPulsarUpdateCompressionType) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "ZSTD":
		fallthrough
	case "SNAPPY":
		*e = DestinationPulsarUpdateCompressionType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DestinationPulsarUpdateCompressionType: %v", v)
	}
}

// DestinationPulsarUpdateTopicType - It identifies type of topic. Pulsar supports two kind of topics: persistent and non-persistent. In persistent topic, all messages are durably persisted on disk (that means on multiple disks unless the broker is standalone), whereas non-persistent topic does not persist message into storage disk.
type DestinationPulsarUpdateTopicType string

const (
	DestinationPulsarUpdateTopicTypePersistent    DestinationPulsarUpdateTopicType = "persistent"
	DestinationPulsarUpdateTopicTypeNonPersistent DestinationPulsarUpdateTopicType = "non-persistent"
)

func (e DestinationPulsarUpdateTopicType) ToPointer() *DestinationPulsarUpdateTopicType {
	return &e
}

func (e *DestinationPulsarUpdateTopicType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "persistent":
		fallthrough
	case "non-persistent":
		*e = DestinationPulsarUpdateTopicType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DestinationPulsarUpdateTopicType: %v", v)
	}
}
...
type DestinationPulsarUpdate struct {
	...
	CompressionType DestinationPulsarUpdateCompressionType `json:"compression_type"`
	...
	TopicType DestinationPulsarUpdateTopicType `json:"topic_type"`

...
const (
	DestinationRedshiftSchemasMethodS3Staging DestinationRedshiftSchemasMethod = "S3 Staging"
)
...
// DestinationRedshiftS3BucketRegion - The region of the S3 staging bucket to use if utilising a COPY strategy. See <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/creating-bucket.html#:~:text=In-,Region,-%2C%20choose%20the%20AWS">AWS docs</a> for details.
...
// DestinationRedshiftS3Staging - The method how the data will be uploaded to the database.
type DestinationRedshiftS3Staging struct {
	...
	method          DestinationRedshiftSchemasMethod `const:"S3 Staging" json:"method"`
...
func (o *DestinationRedshiftS3Staging) GetMethod() DestinationRedshiftSchemasMethod {
	return DestinationRedshiftSchemasMethodS3Staging
}
...
const (
	DestinationRedshiftMethodStandard DestinationRedshiftMethod = "Standard"
)
...
// DestinationRedshiftStandard - The method how the data will be uploaded to the database.
type DestinationRedshiftStandard struct {
	method DestinationRedshiftMethod `const:"Standard" json:"method"`
}
...
func (o *DestinationRedshiftStandard) GetMethod() DestinationRedshiftMethod {
	return DestinationRedshiftMethodStandard
}

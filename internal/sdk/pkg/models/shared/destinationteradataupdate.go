...
func (u *DestinationTeradataUpdateSSLModes) UnmarshalJSON(data []byte) error {
	...
	destinationTeradataUpdateDisable := new(DestinationTeradataUpdateDisable)
	...
	destinationTeradataUpdateAllow := new(DestinationTeradataUpdateAllow)
	...
	destinationTeradataUpdatePrefer := new(DestinationTeradataUpdatePrefer)
	...
	destinationTeradataUpdateRequire := new(DestinationTeradataUpdateRequire)
	...
	destinationTeradataUpdateVerifyCa := new(DestinationTeradataUpdateVerifyCa)
	...
	destinationTeradataUpdateVerifyFull := new(DestinationTeradataUpdateVerifyFull)

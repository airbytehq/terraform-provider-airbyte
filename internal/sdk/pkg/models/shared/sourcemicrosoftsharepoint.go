...
func (u *SourceMicrosoftSharepointAuthentication) UnmarshalJSON(data []byte) error {
	...
	sourceMicrosoftSharepointAuthenticateViaMicrosoftOAuth := new(SourceMicrosoftSharepointAuthenticateViaMicrosoftOAuth)
	...
	sourceMicrosoftSharepointServiceKeyAuthentication := new(SourceMicrosoftSharepointServiceKeyAuthentication)
...
func (u *SourceMicrosoftSharepointProcessing) UnmarshalJSON(data []byte) error {
	...
	sourceMicrosoftSharepointLocal := new(SourceMicrosoftSharepointLocal)
...
func (u *SourceMicrosoftSharepointCSVHeaderDefinition) UnmarshalJSON(data []byte) error {
	...
	sourceMicrosoftSharepointFromCSV := new(SourceMicrosoftSharepointFromCSV)
	...
	sourceMicrosoftSharepointAutogenerated := new(SourceMicrosoftSharepointAutogenerated)
	...
	sourceMicrosoftSharepointUserProvided := new(SourceMicrosoftSharepointUserProvided)
...
func (u *SourceMicrosoftSharepointFormat) UnmarshalJSON(data []byte) error {
	...
	sourceMicrosoftSharepointJsonlFormat := new(SourceMicrosoftSharepointJsonlFormat)
	...
	sourceMicrosoftSharepointAvroFormat := new(SourceMicrosoftSharepointAvroFormat)
	...
	sourceMicrosoftSharepointParquetFormat := new(SourceMicrosoftSharepointParquetFormat)
	...
	sourceMicrosoftSharepointDocumentFileTypeFormatExperimental := new(SourceMicrosoftSharepointDocumentFileTypeFormatExperimental)
	...
	sourceMicrosoftSharepointCSVFormat := new(SourceMicrosoftSharepointCSVFormat)

...
func (s *OAuth) OauthCallback(ctx context.Context, request operations.OauthCallbackRequest, opts ...operations.Option) (*operations.OauthCallbackResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/oauth/callback")
	if err != nil {
	...
	res := &operations.OauthCallbackResponse{

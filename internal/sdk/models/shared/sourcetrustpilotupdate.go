...
type SourceTrustpilotUpdateAuthorizationMethod struct {
	SourceTrustpilotUpdateOAuth20 *SourceTrustpilotUpdateOAuth20 `queryParam:"inline"`
	SourceTrustpilotUpdateAPIKey  *SourceTrustpilotUpdateAPIKey  `queryParam:"inline"`

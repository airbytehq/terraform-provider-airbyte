...
type SourceGnewsSourceType string

const (
	SourceGnewsSourceTypeGnews SourceGnewsSourceType = "gnews"
)

func (e SourceGnewsSourceType) ToPointer() *SourceGnewsSourceType {
	return &e
}
func (e *SourceGnewsSourceType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "gnews":
		*e = SourceGnewsSourceType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SourceGnewsSourceType: %v", v)
	}
}
...
type SourceGnews struct {
	...
	sourceType           *SourceGnewsSourceType `const:"gnews" json:"sourceType"`
...
func (s *SourceGnews) GetAPIKey() string {
	if s == nil {
		return ""
	}
	return s.APIKey
...
func (s *SourceGnews) GetCountry() *SourceGnewsCountry {
	if s == nil {
		return nil
	}
	return s.Country
...
func (s *SourceGnews) GetEndDate() *string {
	if s == nil {
		return nil
	}
	return s.EndDate
...
func (s *SourceGnews) GetLanguage() *SourceGnewsLanguage {
	if s == nil {
		return nil
	}
	return s.Language
...
func (s *SourceGnews) GetNullable() []Nullable {
	if s == nil {
		return nil
	}
	return s.Nullable
...
func (s *SourceGnews) GetQuery() string {
	if s == nil {
		return ""
	}
	return s.Query
...
func (s *SourceGnews) GetSortby() *SourceGnewsSortBy {
	if s == nil {
		return nil
	}
	return s.Sortby
...
func (s *SourceGnews) GetStartDate() *string {
	if s == nil {
		return nil
	}
	return s.StartDate
...
func (s *SourceGnews) GetTopHeadlinesQuery() *string {
	if s == nil {
		return nil
	}
...
func (s *SourceGnews) GetTopHeadlinesTopic() *TopHeadlinesTopic {
	if s == nil {
		return nil
	}
...
func (s *SourceGnews) GetSourceType() *SourceGnewsSourceType {
	return SourceGnewsSourceTypeGnews.ToPointer()
}

func (s *SourceGnews) GetAdditionalProperties() any {
	if s == nil {
		return nil
	}

...
type SourceSftpBulkProcessing struct {
	SourceSftpBulkLocal  *SourceSftpBulkLocal  `queryParam:"inline"`
	SourceSftpBulkViaAPI *SourceSftpBulkViaAPI `queryParam:"inline"`
...
type SourceSftpBulkCSVHeaderDefinition struct {
	SourceSftpBulkFromCSV       *SourceSftpBulkFromCSV       `queryParam:"inline"`
	SourceSftpBulkAutogenerated *SourceSftpBulkAutogenerated `queryParam:"inline"`
	SourceSftpBulkUserProvided  *SourceSftpBulkUserProvided  `queryParam:"inline"`
...
type SourceSftpBulkFormat struct {
	SourceSftpBulkAvroFormat                 *SourceSftpBulkAvroFormat                 `queryParam:"inline"`
	SourceSftpBulkCSVFormat                  *SourceSftpBulkCSVFormat                  `queryParam:"inline"`
	SourceSftpBulkJsonlFormat                *SourceSftpBulkJsonlFormat                `queryParam:"inline"`
	SourceSftpBulkParquetFormat              *SourceSftpBulkParquetFormat              `queryParam:"inline"`
	SourceSftpBulkUnstructuredDocumentFormat *SourceSftpBulkUnstructuredDocumentFormat `queryParam:"inline"`
	SourceSftpBulkExcelFormat                *SourceSftpBulkExcelFormat                `queryParam:"inline"`
...
func (o *SourceSftpBulkCopyRawFiles) GetDeliveryType() *SourceSftpBulkSchemasDeliveryType {
	return SourceSftpBulkSchemasDeliveryTypeUseFileTransfer.ToPointer()
}

func (o *SourceSftpBulkCopyRawFiles) GetPreserveDirectoryStructure() *bool {
	if o == nil {
		return nil
	}
...
func (o *SourceSftpBulkReplicateRecords) GetDeliveryType() *SourceSftpBulkDeliveryType {
...
type SourceSftpBulkDeliveryMethod struct {
	SourceSftpBulkReplicateRecords *SourceSftpBulkReplicateRecords `queryParam:"inline"`
	SourceSftpBulkCopyRawFiles     *SourceSftpBulkCopyRawFiles     `queryParam:"inline"`
...
func (u *SourceSftpBulkDeliveryMethod) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &sourceSftpBulkReplicateRecords, "", true, true); err == nil {
		u.SourceSftpBulkReplicateRecords = &sourceSftpBulkReplicateRecords
		u.Type = SourceSftpBulkDeliveryMethodTypeSourceSftpBulkReplicateRecords
		return nil
	}

	var sourceSftpBulkCopyRawFiles SourceSftpBulkCopyRawFiles = SourceSftpBulkCopyRawFiles{}
	if err := utils.UnmarshalJSON(data, &sourceSftpBulkCopyRawFiles, "", true, true); err == nil {
		u.SourceSftpBulkCopyRawFiles = &sourceSftpBulkCopyRawFiles
		u.Type = SourceSftpBulkDeliveryMethodTypeSourceSftpBulkCopyRawFiles
		return nil
	}
...
func (o *AuthenticateViaPrivateKey) GetAuthType() *SourceSftpBulkSchemasAuthType {
...
func (o *AuthenticateViaPassword) GetAuthType() *SourceSftpBulkAuthType {
...
type SourceSftpBulkAuthentication struct {
	AuthenticateViaPassword   *AuthenticateViaPassword   `queryParam:"inline"`
	AuthenticateViaPrivateKey *AuthenticateViaPrivateKey `queryParam:"inline"`
...
func (u *SourceSftpBulkAuthentication) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &authenticateViaPassword, "", true, true); err == nil {
		...
		u.Type = SourceSftpBulkAuthenticationTypeAuthenticateViaPassword
		return nil
	}
	...
	if err := utils.UnmarshalJSON(data, &authenticateViaPrivateKey, "", true, true); err == nil {
		...
		u.Type = SourceSftpBulkAuthenticationTypeAuthenticateViaPrivateKey
		return nil
	}
...
func (o *SourceSftpBulk) GetDeliveryMethod() *SourceSftpBulkDeliveryMethod {
	if o == nil {
		return nil
	}

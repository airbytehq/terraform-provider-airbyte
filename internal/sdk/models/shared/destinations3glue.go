...
type DestinationS3GlueCompression struct {
	DestinationS3GlueNoCompression *DestinationS3GlueNoCompression `queryParam:"inline"`
	DestinationS3GlueGZIP          *DestinationS3GlueGZIP          `queryParam:"inline"`
...
type DestinationS3GlueOutputFormat struct {
	DestinationS3GlueJSONLinesNewlineDelimitedJSON *DestinationS3GlueJSONLinesNewlineDelimitedJSON `queryParam:"inline"`
...
func (o *DestinationS3Glue) GetGlueSerializationLibrary() *SerializationLibrary {
	if o == nil {
		return nil
	}

...
type DestinationPgvectorEmbedding struct {
	DestinationPgvectorOpenAI           *DestinationPgvectorOpenAI           `queryParam:"inline"`
	DestinationPgvectorCohere           *DestinationPgvectorCohere           `queryParam:"inline"`
	DestinationPgvectorFake             *DestinationPgvectorFake             `queryParam:"inline"`
	DestinationPgvectorAzureOpenAI      *DestinationPgvectorAzureOpenAI      `queryParam:"inline"`
	DestinationPgvectorOpenAICompatible *DestinationPgvectorOpenAICompatible `queryParam:"inline"`
...
type DestinationPgvectorTextSplitter struct {
	DestinationPgvectorBySeparator           *DestinationPgvectorBySeparator           `queryParam:"inline"`
	DestinationPgvectorByMarkdownHeader      *DestinationPgvectorByMarkdownHeader      `queryParam:"inline"`
	DestinationPgvectorByProgrammingLanguage *DestinationPgvectorByProgrammingLanguage `queryParam:"inline"`
...
func (o *PostgresConnection) GetCredentials() DestinationPgvectorCredentials {
	if o == nil {
...
func (o *DestinationPgvector) GetIndexing() PostgresConnection {
	if o == nil {

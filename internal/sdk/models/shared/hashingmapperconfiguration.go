...
func (h HashingMapperConfiguration) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(h, "", false)
}

func (h *HashingMapperConfiguration) UnmarshalJSON(data []byte) error {
...
func (h *HashingMapperConfiguration) GetFieldNameSuffix() string {
	if h == nil {
		return ""
	}
...
func (h *HashingMapperConfiguration) GetMethod() HashingMethod {
	if h == nil {
...
func (h *HashingMapperConfiguration) GetTargetField() string {
	if h == nil {
		return ""
	}

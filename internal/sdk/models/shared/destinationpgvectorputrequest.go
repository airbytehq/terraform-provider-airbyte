...
func (d *DestinationPgvectorPutRequest) GetName() string {
	if d == nil {
		return ""
	}
	return d.Name
...
func (d *DestinationPgvectorPutRequest) GetWorkspaceID() string {
	if d == nil {
		return ""
	}
...
func (d *DestinationPgvectorPutRequest) GetConfiguration() DestinationPgvectorUpdate {
	if d == nil {

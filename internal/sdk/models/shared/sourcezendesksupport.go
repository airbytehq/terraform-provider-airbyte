...
type SourceZendeskSupportAuthentication struct {
	SourceZendeskSupportOAuth20  *SourceZendeskSupportOAuth20  `queryParam:"inline"`
	SourceZendeskSupportAPIToken *SourceZendeskSupportAPIToken `queryParam:"inline"`
...
func (o *SourceZendeskSupport) GetNumWorkers() *int64 {
	if o == nil {
		return nil
	}
	return o.NumWorkers

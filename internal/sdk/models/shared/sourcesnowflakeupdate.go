...
type SourceSnowflakeUpdateAuthorizationMethod struct {
	SourceSnowflakeUpdateOAuth20               *SourceSnowflakeUpdateOAuth20               `queryParam:"inline"`
	SourceSnowflakeUpdateKeyPairAuthentication *SourceSnowflakeUpdateKeyPairAuthentication `queryParam:"inline"`
	SourceSnowflakeUpdateUsernameAndPassword   *SourceSnowflakeUpdateUsernameAndPassword   `queryParam:"inline"`

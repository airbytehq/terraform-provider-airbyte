...
func (u *SourceCartAuthorizationMethod) UnmarshalJSON(data []byte) error {
	...
	return fmt.Errorf("could not unmarshal `%s` into any supported union types for SourceCartAuthorizationMethod", string(data))
}
...
func (u SourceCartAuthorizationMethod) MarshalJSON() ([]byte, error) {
	...
	return nil, errors.New("could not marshal union type SourceCartAuthorizationMethod: all fields are null")
}

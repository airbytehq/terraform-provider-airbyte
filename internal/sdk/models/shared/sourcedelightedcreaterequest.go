...
func (s *SourceDelightedCreateRequest) GetDefinitionID() *string {
	if s == nil {
		return nil
	}
...
func (s *SourceDelightedCreateRequest) GetWorkspaceID() string {
	if s == nil {
		return ""
	}
...
func (s *SourceDelightedCreateRequest) GetConfiguration() SourceDelighted {
	if s == nil {
...
func (s *SourceDelightedCreateRequest) GetSecretID() *string {
	if s == nil {
		return nil
	}
	return s.SecretID

...
type DestinationPgvectorUpdateEmbedding struct {
	DestinationPgvectorUpdateOpenAI           *DestinationPgvectorUpdateOpenAI           `queryParam:"inline"`
	DestinationPgvectorUpdateCohere           *DestinationPgvectorUpdateCohere           `queryParam:"inline"`
	DestinationPgvectorUpdateFake             *DestinationPgvectorUpdateFake             `queryParam:"inline"`
	DestinationPgvectorUpdateAzureOpenAI      *DestinationPgvectorUpdateAzureOpenAI      `queryParam:"inline"`
	DestinationPgvectorUpdateOpenAICompatible *DestinationPgvectorUpdateOpenAICompatible `queryParam:"inline"`
...
type DestinationPgvectorUpdateTextSplitter struct {
	DestinationPgvectorUpdateBySeparator           *DestinationPgvectorUpdateBySeparator           `queryParam:"inline"`
	DestinationPgvectorUpdateByMarkdownHeader      *DestinationPgvectorUpdateByMarkdownHeader      `queryParam:"inline"`
	DestinationPgvectorUpdateByProgrammingLanguage *DestinationPgvectorUpdateByProgrammingLanguage `queryParam:"inline"`

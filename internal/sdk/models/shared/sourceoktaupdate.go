...
func (o *SourceOktaUpdateOAuth20WithPrivateKey) GetAuthType() SourceOktaUpdateSchemasAuthType {
	return SourceOktaUpdateSchemasAuthTypeOauth20PrivateKey
}

func (o *SourceOktaUpdateOAuth20WithPrivateKey) GetClientID() string {
	if o == nil {
		return ""
	}
	return o.ClientID
...
func (o *SourceOktaUpdateOAuth20WithPrivateKey) GetKeyID() string {
	if o == nil {
		return ""
	}
	return o.KeyID
...
func (o *SourceOktaUpdateOAuth20WithPrivateKey) GetPrivateKey() string {
	if o == nil {
		return ""
	}
	return o.PrivateKey
...
func (o *SourceOktaUpdateOAuth20WithPrivateKey) GetScope() string {
	if o == nil {
		return ""
	}
	return o.Scope
...
type SourceOktaUpdateAuthorizationMethod struct {
	SourceOktaUpdateOAuth20               *SourceOktaUpdateOAuth20               `queryParam:"inline"`
	SourceOktaUpdateOAuth20WithPrivateKey *SourceOktaUpdateOAuth20WithPrivateKey `queryParam:"inline"`
	SourceOktaUpdateAPIToken              *SourceOktaUpdateAPIToken              `queryParam:"inline"`
...
func (u *SourceOktaUpdateAuthorizationMethod) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &sourceOktaUpdateOAuth20WithPrivateKey, "", true, true); err == nil {
		u.SourceOktaUpdateOAuth20WithPrivateKey = &sourceOktaUpdateOAuth20WithPrivateKey
		u.Type = SourceOktaUpdateAuthorizationMethodTypeSourceOktaUpdateOAuth20WithPrivateKey
		return nil
	}

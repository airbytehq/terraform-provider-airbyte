...
type SourceMongodbV2ClusterType string

const (
	SourceMongodbV2ClusterTypeSelfManagedReplicaSet SourceMongodbV2ClusterType = "SELF_MANAGED_REPLICA_SET"
)

func (e SourceMongodbV2ClusterType) ToPointer() *SourceMongodbV2ClusterType {
	return &e
}
func (e *SourceMongodbV2ClusterType) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "SELF_MANAGED_REPLICA_SET":
		*e = SourceMongodbV2ClusterType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SourceMongodbV2ClusterType: %v", v)
	}
}
...
type ClusterType struct {
	MongoDBAtlasReplicaSet *MongoDBAtlasReplicaSet `queryParam:"inline"`
	SelfManagedReplicaSet  *SelfManagedReplicaSet  `queryParam:"inline"`
...
func (o *SourceMongodbV2) GetDatabaseConfig() ClusterType {
	if o == nil {
		return ClusterType{}
	}

...
type DestinationSnowflakeCortexEmbedding struct {
	DestinationSnowflakeCortexOpenAI           *DestinationSnowflakeCortexOpenAI           `queryParam:"inline"`
	DestinationSnowflakeCortexCohere           *DestinationSnowflakeCortexCohere           `queryParam:"inline"`
	DestinationSnowflakeCortexFake             *DestinationSnowflakeCortexFake             `queryParam:"inline"`
	DestinationSnowflakeCortexAzureOpenAI      *DestinationSnowflakeCortexAzureOpenAI      `queryParam:"inline"`
	DestinationSnowflakeCortexOpenAICompatible *DestinationSnowflakeCortexOpenAICompatible `queryParam:"inline"`
...
type DestinationSnowflakeCortexTextSplitter struct {
	DestinationSnowflakeCortexBySeparator           *DestinationSnowflakeCortexBySeparator           `queryParam:"inline"`
	DestinationSnowflakeCortexByMarkdownHeader      *DestinationSnowflakeCortexByMarkdownHeader      `queryParam:"inline"`
	DestinationSnowflakeCortexByProgrammingLanguage *DestinationSnowflakeCortexByProgrammingLanguage `queryParam:"inline"`
...
func (o *SnowflakeConnection) GetCredentials() DestinationSnowflakeCortexCredentials {
	if o == nil {
...
func (o *DestinationSnowflakeCortex) GetIndexing() SnowflakeConnection {
	if o == nil {

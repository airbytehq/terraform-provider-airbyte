...
type SourceSenseforceSourceType string

const (
	SourceSenseforceSourceTypeSenseforce SourceSenseforceSourceType = "senseforce"
)

func (e SourceSenseforceSourceType) ToPointer() *SourceSenseforceSourceType {
	return &e
}
func (e *SourceSenseforceSourceType) UnmarshalJSON(data []byte) error {
	var v string
	...
	switch v {
	case "senseforce":
		*e = SourceSenseforceSourceType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SourceSenseforceSourceType: %v", v)
	}
}
...
type SourceSenseforce struct {
	...
	sourceType           *SourceSenseforceSourceType `const:"senseforce" json:"sourceType"`
...
func (s *SourceSenseforce) GetAccessToken() string {
	if s == nil {
		return ""
	}
...
func (s *SourceSenseforce) GetBackendURL() string {
	if s == nil {
		return ""
	}
	return s.BackendURL
...
func (s *SourceSenseforce) GetDatasetID() string {
	if s == nil {
		return ""
	}
	return s.DatasetID
...
func (s *SourceSenseforce) GetSliceRange() *int64 {
	if s == nil {
		return nil
	}
	return s.SliceRange
...
func (s *SourceSenseforce) GetStartDate() types.Date {
	if s == nil {
		return types.Date{}
	}
	return s.StartDate
...
func (s *SourceSenseforce) GetSourceType() *SourceSenseforceSourceType {
	return SourceSenseforceSourceTypeSenseforce.ToPointer()
}

func (s *SourceSenseforce) GetAdditionalProperties() any {
	if s == nil {
		return nil
	}

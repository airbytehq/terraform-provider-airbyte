...
type DestinationS3CompressionCodec struct {
	DestinationS3SchemasFormatNoCompression *DestinationS3SchemasFormatNoCompression `queryParam:"inline"`
	DestinationS3Deflate                    *DestinationS3Deflate                    `queryParam:"inline"`
	DestinationS3Bzip2                      *DestinationS3Bzip2                      `queryParam:"inline"`
	DestinationS3Xz                         *DestinationS3Xz                         `queryParam:"inline"`
	DestinationS3Zstandard                  *DestinationS3Zstandard                  `queryParam:"inline"`
	DestinationS3Snappy                     *DestinationS3Snappy                     `queryParam:"inline"`
...
type DestinationS3SchemasCompression struct {
	DestinationS3SchemasNoCompression *DestinationS3SchemasNoCompression `queryParam:"inline"`
	DestinationS3SchemasGZIP          *DestinationS3SchemasGZIP          `queryParam:"inline"`
...
type DestinationS3OutputFormat struct {
	DestinationS3CSVCommaSeparatedValues       *DestinationS3CSVCommaSeparatedValues       `queryParam:"inline"`
	DestinationS3JSONLinesNewlineDelimitedJSON *DestinationS3JSONLinesNewlineDelimitedJSON `queryParam:"inline"`
	DestinationS3AvroApacheAvro                *DestinationS3AvroApacheAvro                `queryParam:"inline"`
	DestinationS3ParquetColumnarStorage        *DestinationS3ParquetColumnarStorage        `queryParam:"inline"`

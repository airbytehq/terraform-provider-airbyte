...
func (d *DestinationS3ParquetColumnarStorage) GetBlockSizeMb() *int64 {
	if d == nil {
		return nil
	}
...
func (d *DestinationS3ParquetColumnarStorage) GetCompressionCodec() *DestinationS3SchemasCompressionCodec {
	if d == nil {
		return nil
	}
...
func (d *DestinationS3ParquetColumnarStorage) GetDictionaryEncoding() *bool {
	if d == nil {
		return nil
	}
...
func (d *DestinationS3ParquetColumnarStorage) GetDictionaryPageSizeKb() *int64 {
	if d == nil {
		return nil
	}
...
func (d *DestinationS3ParquetColumnarStorage) GetFormatType() *DestinationS3SchemasFormatOutputFormatFormatType {
	if d == nil {
		return nil
	}
	return d.FormatType
...
func (d *DestinationS3ParquetColumnarStorage) GetMaxPaddingSizeMb() *int64 {
	if d == nil {
		return nil
	}
...
func (d *DestinationS3ParquetColumnarStorage) GetPageSizeKb() *int64 {
	if d == nil {
		return nil
	}
	return d.PageSizeKb
...
func (d *DestinationS3ParquetColumnarStorage) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
...
// #region class-body-destinations3parquetcolumnarstorage
// #endregion class-body-destinations3parquetcolumnarstorage
...
func (d *DestinationS3Snappy) GetCodec() *DestinationS3SchemasFormatOutputFormat3CompressionCodecCodec {
	if d == nil {
		return nil
	}
	return d.Codec
...
func (d *DestinationS3Snappy) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3snappy
// #endregion class-body-destinations3snappy
...
func (d *DestinationS3Zstandard) GetCodec() *DestinationS3SchemasFormatOutputFormat3Codec {
	if d == nil {
		return nil
	}
	return d.Codec
...
func (d *DestinationS3Zstandard) GetCompressionLevel() int64 {
	if d == nil {
		return 0
	}
...
func (d *DestinationS3Zstandard) GetIncludeChecksum() bool {
	if d == nil {
		return false
	}
...
func (d *DestinationS3Zstandard) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3zstandard
// #endregion class-body-destinations3zstandard
...
func (d *DestinationS3Xz) GetCodec() *DestinationS3SchemasFormatOutputFormatCodec {
	if d == nil {
		return nil
	}
	return d.Codec
...
func (d *DestinationS3Xz) GetCompressionLevel() int64 {
	if d == nil {
		return 0
	}
	return d.CompressionLevel
...
func (d *DestinationS3Xz) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3xz
// #endregion class-body-destinations3xz
...
func (d *DestinationS3Bzip2) GetCodec() *DestinationS3SchemasFormatCodec {
	if d == nil {
		return nil
	}
	return d.Codec
...
func (d *DestinationS3Bzip2) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3bzip2
// #endregion class-body-destinations3bzip2
...
func (d *DestinationS3Deflate) GetCodec() *DestinationS3SchemasCodec {
	if d == nil {
		return nil
	}
	return d.Codec
...
func (d *DestinationS3Deflate) GetCompressionLevel() int64 {
	if d == nil {
		return 0
	}
	return d.CompressionLevel
...
func (d *DestinationS3Deflate) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3deflate
// #endregion class-body-destinations3deflate
...
func (d *DestinationS3SchemasFormatNoCompression) GetCodec() *DestinationS3Codec {
	if d == nil {
		return nil
	}
	return d.Codec
...
func (d *DestinationS3SchemasFormatNoCompression) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3schemasformatnocompression
// #endregion class-body-destinations3schemasformatnocompression
...
type DestinationS3CompressionCodec struct {
	DestinationS3SchemasFormatNoCompression *DestinationS3SchemasFormatNoCompression `queryParam:"inline" union:"member"`
	DestinationS3Deflate                    *DestinationS3Deflate                    `queryParam:"inline" union:"member"`
	DestinationS3Bzip2                      *DestinationS3Bzip2                      `queryParam:"inline" union:"member"`
	DestinationS3Xz                         *DestinationS3Xz                         `queryParam:"inline" union:"member"`
	DestinationS3Zstandard                  *DestinationS3Zstandard                  `queryParam:"inline" union:"member"`
	DestinationS3Snappy                     *DestinationS3Snappy                     `queryParam:"inline" union:"member"`
...
func (u *DestinationS3CompressionCodec) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &destinationS3SchemasFormatNoCompression, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3CompressionCodecTypeDestinationS3SchemasFormatNoCompression,
			Value: &destinationS3SchemasFormatNoCompression,
		})
	}

	var destinationS3Deflate DestinationS3Deflate = DestinationS3Deflate{}
	if err := utils.UnmarshalJSON(data, &destinationS3Deflate, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3CompressionCodecTypeDestinationS3Deflate,
			Value: &destinationS3Deflate,
		})
	}

	var destinationS3Bzip2 DestinationS3Bzip2 = DestinationS3Bzip2{}
	if err := utils.UnmarshalJSON(data, &destinationS3Bzip2, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3CompressionCodecTypeDestinationS3Bzip2,
			Value: &destinationS3Bzip2,
		})
	}

	var destinationS3Xz DestinationS3Xz = DestinationS3Xz{}
	if err := utils.UnmarshalJSON(data, &destinationS3Xz, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3CompressionCodecTypeDestinationS3Xz,
			Value: &destinationS3Xz,
		})
	}

	var destinationS3Zstandard DestinationS3Zstandard = DestinationS3Zstandard{}
	if err := utils.UnmarshalJSON(data, &destinationS3Zstandard, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3CompressionCodecTypeDestinationS3Zstandard,
			Value: &destinationS3Zstandard,
		})
	}

	var destinationS3Snappy DestinationS3Snappy = DestinationS3Snappy{}
	if err := utils.UnmarshalJSON(data, &destinationS3Snappy, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3CompressionCodecTypeDestinationS3Snappy,
			Value: &destinationS3Snappy,
		})
	}
	...
	u.Type = best.Type.(DestinationS3CompressionCodecType)
	switch best.Type {
	case DestinationS3CompressionCodecTypeDestinationS3SchemasFormatNoCompression:
		u.DestinationS3SchemasFormatNoCompression = best.Value.(*DestinationS3SchemasFormatNoCompression)
		return nil
	case DestinationS3CompressionCodecTypeDestinationS3Deflate:
		u.DestinationS3Deflate = best.Value.(*DestinationS3Deflate)
		return nil
	case DestinationS3CompressionCodecTypeDestinationS3Bzip2:
		u.DestinationS3Bzip2 = best.Value.(*DestinationS3Bzip2)
		return nil
	case DestinationS3CompressionCodecTypeDestinationS3Xz:
		u.DestinationS3Xz = best.Value.(*DestinationS3Xz)
		return nil
	case DestinationS3CompressionCodecTypeDestinationS3Zstandard:
		u.DestinationS3Zstandard = best.Value.(*DestinationS3Zstandard)
		return nil
	case DestinationS3CompressionCodecTypeDestinationS3Snappy:
		u.DestinationS3Snappy = best.Value.(*DestinationS3Snappy)
		return nil
	}
...
func (d *DestinationS3AvroApacheAvro) GetCompressionCodec() DestinationS3CompressionCodec {
	if d == nil {
		return DestinationS3CompressionCodec{}
	}
	return d.CompressionCodec
...
func (d *DestinationS3AvroApacheAvro) GetFormatType() *DestinationS3SchemasFormatFormatType {
	if d == nil {
		return nil
	}
	return d.FormatType
...
func (d *DestinationS3AvroApacheAvro) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3avroapacheavro
// #endregion class-body-destinations3avroapacheavro
...
func (d *DestinationS3SchemasGZIP) GetCompressionType() *DestinationS3SchemasFormatOutputFormatCompressionType {
	if d == nil {
		return nil
	}
...
func (d *DestinationS3SchemasGZIP) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3schemasgzip
// #endregion class-body-destinations3schemasgzip
...
func (d *DestinationS3SchemasNoCompression) GetCompressionType() *DestinationS3SchemasFormatCompressionType {
	if d == nil {
		return nil
	}
	return d.CompressionType
...
func (d *DestinationS3SchemasNoCompression) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3schemasnocompression
// #endregion class-body-destinations3schemasnocompression
...
type DestinationS3SchemasCompression struct {
	DestinationS3SchemasNoCompression *DestinationS3SchemasNoCompression `queryParam:"inline" union:"member"`
	DestinationS3SchemasGZIP          *DestinationS3SchemasGZIP          `queryParam:"inline" union:"member"`
...
func (u *DestinationS3SchemasCompression) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &destinationS3SchemasNoCompression, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3SchemasCompressionUnionTypeDestinationS3SchemasNoCompression,
			Value: &destinationS3SchemasNoCompression,
		})
	}

	var destinationS3SchemasGZIP DestinationS3SchemasGZIP = DestinationS3SchemasGZIP{}
	if err := utils.UnmarshalJSON(data, &destinationS3SchemasGZIP, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3SchemasCompressionUnionTypeDestinationS3SchemasGZIP,
			Value: &destinationS3SchemasGZIP,
		})
	}
	...
	// Set the union type and value based on the best candidate
	u.Type = best.Type.(DestinationS3SchemasCompressionUnionType)
	switch best.Type {
	case DestinationS3SchemasCompressionUnionTypeDestinationS3SchemasNoCompression:
		u.DestinationS3SchemasNoCompression = best.Value.(*DestinationS3SchemasNoCompression)
		return nil
	case DestinationS3SchemasCompressionUnionTypeDestinationS3SchemasGZIP:
		u.DestinationS3SchemasGZIP = best.Value.(*DestinationS3SchemasGZIP)
		return nil
	}
...
func (d *DestinationS3JSONLinesNewlineDelimitedJSON) GetCompression() *DestinationS3SchemasCompression {
	if d == nil {
		return nil
	}
...
func (d *DestinationS3JSONLinesNewlineDelimitedJSON) GetFlattening() *DestinationS3SchemasFlattening {
	if d == nil {
		return nil
	}
	return d.Flattening
...
func (d *DestinationS3JSONLinesNewlineDelimitedJSON) GetFormatType() *DestinationS3SchemasFormatType {
	if d == nil {
		return nil
	}
	return d.FormatType
...
func (d *DestinationS3JSONLinesNewlineDelimitedJSON) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3jsonlinesnewlinedelimitedjson
// #endregion class-body-destinations3jsonlinesnewlinedelimitedjson
...
func (d *DestinationS3GZIP) GetCompressionType() *DestinationS3SchemasCompressionType {
	if d == nil {
		return nil
	}
	return d.CompressionType
...
func (d *DestinationS3GZIP) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3gzip
// #endregion class-body-destinations3gzip
...
func (d *DestinationS3NoCompression) GetCompressionType() *DestinationS3CompressionType {
	if d == nil {
		return nil
	}
	return d.CompressionType
...
func (d *DestinationS3NoCompression) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3nocompression
// #endregion class-body-destinations3nocompression
...
type DestinationS3Compression struct {
	DestinationS3NoCompression *DestinationS3NoCompression `queryParam:"inline" union:"member"`
	DestinationS3GZIP          *DestinationS3GZIP          `queryParam:"inline" union:"member"`
...
func (u *DestinationS3Compression) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &destinationS3NoCompression, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3CompressionUnionTypeDestinationS3NoCompression,
			Value: &destinationS3NoCompression,
		})
	}

	var destinationS3GZIP DestinationS3GZIP = DestinationS3GZIP{}
	if err := utils.UnmarshalJSON(data, &destinationS3GZIP, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3CompressionUnionTypeDestinationS3GZIP,
			Value: &destinationS3GZIP,
		})
	}
	...
	// Set the union type and value based on the best candidate
	u.Type = best.Type.(DestinationS3CompressionUnionType)
	switch best.Type {
	case DestinationS3CompressionUnionTypeDestinationS3NoCompression:
		u.DestinationS3NoCompression = best.Value.(*DestinationS3NoCompression)
		return nil
	case DestinationS3CompressionUnionTypeDestinationS3GZIP:
		u.DestinationS3GZIP = best.Value.(*DestinationS3GZIP)
		return nil
	}
...
func (d *DestinationS3CSVCommaSeparatedValues) GetCompression() *DestinationS3Compression {
	if d == nil {
		return nil
	}
	return d.Compression
...
func (d *DestinationS3CSVCommaSeparatedValues) GetFlattening() *DestinationS3Flattening {
	if d == nil {
		return nil
	}
	return d.Flattening
...
func (d *DestinationS3CSVCommaSeparatedValues) GetFormatType() *DestinationS3FormatType {
	if d == nil {
		return nil
	}
	return d.FormatType
...
func (d *DestinationS3CSVCommaSeparatedValues) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3csvcommaseparatedvalues
// #endregion class-body-destinations3csvcommaseparatedvalues
...
type DestinationS3OutputFormat struct {
	DestinationS3CSVCommaSeparatedValues       *DestinationS3CSVCommaSeparatedValues       `queryParam:"inline" union:"member"`
	DestinationS3JSONLinesNewlineDelimitedJSON *DestinationS3JSONLinesNewlineDelimitedJSON `queryParam:"inline" union:"member"`
	DestinationS3AvroApacheAvro                *DestinationS3AvroApacheAvro                `queryParam:"inline" union:"member"`
	DestinationS3ParquetColumnarStorage        *DestinationS3ParquetColumnarStorage        `queryParam:"inline" union:"member"`
...
func (u *DestinationS3OutputFormat) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &destinationS3CSVCommaSeparatedValues, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3OutputFormatTypeDestinationS3CSVCommaSeparatedValues,
			Value: &destinationS3CSVCommaSeparatedValues,
		})
	}
	...
	if err := utils.UnmarshalJSON(data, &destinationS3JSONLinesNewlineDelimitedJSON, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3OutputFormatTypeDestinationS3JSONLinesNewlineDelimitedJSON,
			Value: &destinationS3JSONLinesNewlineDelimitedJSON,
		})
	}

	var destinationS3AvroApacheAvro DestinationS3AvroApacheAvro = DestinationS3AvroApacheAvro{}
	if err := utils.UnmarshalJSON(data, &destinationS3AvroApacheAvro, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3OutputFormatTypeDestinationS3AvroApacheAvro,
			Value: &destinationS3AvroApacheAvro,
		})
	}

	var destinationS3ParquetColumnarStorage DestinationS3ParquetColumnarStorage = DestinationS3ParquetColumnarStorage{}
	if err := utils.UnmarshalJSON(data, &destinationS3ParquetColumnarStorage, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  DestinationS3OutputFormatTypeDestinationS3ParquetColumnarStorage,
			Value: &destinationS3ParquetColumnarStorage,
		})
	}
	...
	// Set the union type and value based on the best candidate
	u.Type = best.Type.(DestinationS3OutputFormatType)
	switch best.Type {
	case DestinationS3OutputFormatTypeDestinationS3CSVCommaSeparatedValues:
		u.DestinationS3CSVCommaSeparatedValues = best.Value.(*DestinationS3CSVCommaSeparatedValues)
		return nil
	case DestinationS3OutputFormatTypeDestinationS3JSONLinesNewlineDelimitedJSON:
		u.DestinationS3JSONLinesNewlineDelimitedJSON = best.Value.(*DestinationS3JSONLinesNewlineDelimitedJSON)
		return nil
	case DestinationS3OutputFormatTypeDestinationS3AvroApacheAvro:
		u.DestinationS3AvroApacheAvro = best.Value.(*DestinationS3AvroApacheAvro)
		return nil
	case DestinationS3OutputFormatTypeDestinationS3ParquetColumnarStorage:
		u.DestinationS3ParquetColumnarStorage = best.Value.(*DestinationS3ParquetColumnarStorage)
		return nil
	}
...
type DestinationS3DestinationType string

const (
	DestinationS3DestinationTypeS3 DestinationS3DestinationType = "s3"
)

func (e DestinationS3DestinationType) ToPointer() *DestinationS3DestinationType {
	return &e
}
func (e *DestinationS3DestinationType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "s3":
		*e = DestinationS3DestinationType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DestinationS3DestinationType: %v", v)
	}
}
...
type DestinationS3 struct {
	...
	destinationType      *DestinationS3DestinationType `const:"s3" json:"destinationType"`
	AdditionalProperties any                           `additionalProperties:"true" json:"-"`
}
...
func (d *DestinationS3) GetAccessKeyID() *string {
	if d == nil {
		return nil
	}
...
func (d *DestinationS3) GetFileNamePattern() *string {
	if d == nil {
		return nil
	}
...
func (d *DestinationS3) GetFormat() DestinationS3OutputFormat {
	if d == nil {
		return DestinationS3OutputFormat{}
	}
	return d.Format
...
func (d *DestinationS3) GetRoleArn() *string {
	if d == nil {
		return nil
	}
	return d.RoleArn
...
func (d *DestinationS3) GetS3BucketName() string {
	if d == nil {
		return ""
	}
...
func (d *DestinationS3) GetS3BucketPath() string {
	if d == nil {
		return ""
	}
...
func (d *DestinationS3) GetS3BucketRegion() *DestinationS3S3BucketRegion {
	if d == nil {
		return nil
	}
...
func (d *DestinationS3) GetS3Endpoint() *string {
	if d == nil {
		return nil
	}
	return d.S3Endpoint
...
func (d *DestinationS3) GetS3PathFormat() *string {
	if d == nil {
		return nil
	}
...
func (d *DestinationS3) GetSecretAccessKey() *string {
	if d == nil {
		return nil
	}
...
func (d *DestinationS3) GetDestinationType() *DestinationS3DestinationType {
	return DestinationS3DestinationTypeS3.ToPointer()
}

func (d *DestinationS3) GetAdditionalProperties() any {
	if d == nil {
		return nil
	}
	return d.AdditionalProperties
...
// #region class-body-destinations3
// #endregion class-body-destinations3

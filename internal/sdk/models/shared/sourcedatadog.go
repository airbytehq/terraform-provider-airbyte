...
func (q *Queries) GetDataSource() DataSource {
	if q == nil {
		return DataSource("")
	}
	return q.DataSource
...
func (q *Queries) GetQuery() string {
	if q == nil {
		return ""
	}
	return q.Query
...
type SourceDatadogSourceType string

const (
	SourceDatadogSourceTypeDatadog SourceDatadogSourceType = "datadog"
)

func (e SourceDatadogSourceType) ToPointer() *SourceDatadogSourceType {
	return &e
}
func (e *SourceDatadogSourceType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "datadog":
		*e = SourceDatadogSourceType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SourceDatadogSourceType: %v", v)
	}
}
...
func (s *SourceDatadog) GetAPIKey() string {
	if s == nil {
		return ""
	}
	return s.APIKey
...
func (s *SourceDatadog) GetApplicationKey() string {
	if s == nil {
		return ""
	}
...
func (s *SourceDatadog) GetEndDate() *string {
	if s == nil {
		return nil
	}
	return s.EndDate
...
func (s *SourceDatadog) GetMaxRecordsPerRequest() *int64 {
	if s == nil {
		return nil
	}
...
func (s *SourceDatadog) GetQueries() []Queries {
	if s == nil {
		return nil
	}
	return s.Queries
...
func (s *SourceDatadog) GetQuery() *string {
	if s == nil {
		return nil
	}
	return s.Query
...
func (s *SourceDatadog) GetSite() *Site {
	if s == nil {
		return nil
	}
	return s.Site
...
func (s *SourceDatadog) GetStartDate() *string {
	if s == nil {
		return nil
	}
	return s.StartDate
...
func (s *SourceDatadog) GetSourceType() *SourceDatadogSourceType {
	return SourceDatadogSourceTypeDatadog.ToPointer()
}

func (s *SourceDatadog) GetAdditionalProperties() any {
	if s == nil {
		return nil
	}

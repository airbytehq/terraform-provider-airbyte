...
func (s *SourceGoogleAdsUpdateGoogleCredentials) GetAccessToken() *string {
	if s == nil {
		return nil
	}
...
func (s *SourceGoogleAdsUpdateGoogleCredentials) GetClientID() *string {
	if s == nil {
		return nil
	}
	return s.ClientID
...
func (s *SourceGoogleAdsUpdateGoogleCredentials) GetClientSecret() *string {
	if s == nil {
		return nil
	}
...
func (s *SourceGoogleAdsUpdateGoogleCredentials) GetDeveloperToken() *string {
	if s == nil {
		return nil
	}
...
func (s *SourceGoogleAdsUpdateGoogleCredentials) GetRefreshToken() *string {
	if s == nil {
		return nil
	}
...
func (s *SourceGoogleAdsUpdateCustomQueriesArray) GetQuery() *string {
	if s == nil {
		return nil
	}
	return s.Query
...
func (s *SourceGoogleAdsUpdateCustomQueriesArray) GetTableName() *string {
	if s == nil {
		return nil
	}
	return s.TableName
...
type SourceGoogleAdsUpdateSourceType string

const (
	SourceGoogleAdsUpdateSourceTypeGoogleAds SourceGoogleAdsUpdateSourceType = "google-ads"
)

func (e SourceGoogleAdsUpdateSourceType) ToPointer() *SourceGoogleAdsUpdateSourceType {
	return &e
}
func (e *SourceGoogleAdsUpdateSourceType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "google-ads":
		*e = SourceGoogleAdsUpdateSourceType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SourceGoogleAdsUpdateSourceType: %v", v)
	}
}
...
type SourceGoogleAdsUpdate struct {
	...
	Credentials          *SourceGoogleAdsUpdateGoogleCredentials   `json:"credentials,omitempty"`
	...
	sourceType           *SourceGoogleAdsUpdateSourceType `const:"google-ads" json:"sourceType"`
...
func (s *SourceGoogleAdsUpdate) GetConversionWindowDays() *int64 {
	if s == nil {
		return nil
	}
...
func (s *SourceGoogleAdsUpdate) GetCredentials() *SourceGoogleAdsUpdateGoogleCredentials {
	if s == nil {
		return nil
	}
...
func (s *SourceGoogleAdsUpdate) GetCustomQueriesArray() []SourceGoogleAdsUpdateCustomQueriesArray {
	if s == nil {
		return nil
	}
...
func (s *SourceGoogleAdsUpdate) GetCustomerID() *string {
	if s == nil {
		return nil
	}
	return s.CustomerID
...
func (s *SourceGoogleAdsUpdate) GetCustomerStatusFilter() []SourceGoogleAdsUpdateCustomerStatus {
	if s == nil {
		return nil
	}
...
func (s *SourceGoogleAdsUpdate) GetEndDate() *types.Date {
	if s == nil {
		return nil
	}
	return s.EndDate
...
func (s *SourceGoogleAdsUpdate) GetNumWorkers() *int64 {
	if s == nil {
		return nil
	}
	return s.NumWorkers
...
func (s *SourceGoogleAdsUpdate) GetStartDate() *types.Date {
	if s == nil {
		return nil
	}
	return s.StartDate
...
func (s *SourceGoogleAdsUpdate) GetSourceType() *SourceGoogleAdsUpdateSourceType {
	return SourceGoogleAdsUpdateSourceTypeGoogleAds.ToPointer()
}

func (s *SourceGoogleAdsUpdate) GetAdditionalProperties() any {
	if s == nil {
		return nil
	}

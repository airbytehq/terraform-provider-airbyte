...
type SourceGnewsUpdateSourceType string

const (
	SourceGnewsUpdateSourceTypeGnews SourceGnewsUpdateSourceType = "gnews"
)

func (e SourceGnewsUpdateSourceType) ToPointer() *SourceGnewsUpdateSourceType {
	return &e
}
func (e *SourceGnewsUpdateSourceType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "gnews":
		*e = SourceGnewsUpdateSourceType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SourceGnewsUpdateSourceType: %v", v)
	}
}
...
func (s *SourceGnewsUpdate) UnmarshalJSON(data []byte) error {
...
func (s *SourceGnewsUpdate) GetAPIKey() *string {
	if s == nil {
		return nil
	}
	return s.APIKey
...
func (s *SourceGnewsUpdate) GetCountry() *SourceGnewsUpdateCountry {
	if s == nil {
		return nil
	}
	return s.Country
...
func (s *SourceGnewsUpdate) GetEndDate() *string {
	if s == nil {
		return nil
	}
	return s.EndDate
...
func (s *SourceGnewsUpdate) GetIn() []SourceGnewsUpdateIn {
	if s == nil {
		return nil
	}
	return s.In
...
func (s *SourceGnewsUpdate) GetLanguage() *SourceGnewsUpdateLanguage {
	if s == nil {
		return nil
	}
	return s.Language
...
func (s *SourceGnewsUpdate) GetNullable() []SourceGnewsUpdateNullable {
	if s == nil {
		return nil
	}
	return s.Nullable
...
func (s *SourceGnewsUpdate) GetQuery() *string {
	if s == nil {
		return nil
	}
	return s.Query
...
func (s *SourceGnewsUpdate) GetSortby() *SourceGnewsUpdateSortBy {
	if s == nil {
		return nil
	}
	return s.Sortby
...
func (s *SourceGnewsUpdate) GetStartDate() *string {
	if s == nil {
		return nil
	}
	return s.StartDate
...
func (s *SourceGnewsUpdate) GetTopHeadlinesQuery() *string {
	if s == nil {
		return nil
	}
	return s.TopHeadlinesQuery
}

func (s *SourceGnewsUpdate) GetTopHeadlinesTopic() *SourceGnewsUpdateTopHeadlinesTopic {
	if s == nil {
		return nil
	}
	return s.TopHeadlinesTopic
}

func (s *SourceGnewsUpdate) GetSourceType() *SourceGnewsUpdateSourceType {
	return SourceGnewsUpdateSourceTypeGnews.ToPointer()
}

func (s *SourceGnewsUpdate) GetAdditionalProperties() any {
	if s == nil {
		return nil
	}

...
func (o *OAuth20) GetAuthMethod() string {
	return "oauth2.0"
}
...
const (
	...
	SourcePinterestSchemasValidEnumsTotalImpression                              SourcePinterestSchemasValidEnums = "TOTAL_IMPRESSION"
...
func (r *ReportConfig) GetAttributionTypes() []SourcePinterestValidEnums {
	if r == nil {
		return nil
	}
	return r.AttributionTypes
}

func (r *ReportConfig) GetClickWindowDays() *ClickWindowDays {
	if r == nil {
		return nil
	}
	return r.ClickWindowDays
}

func (r *ReportConfig) GetColumns() []SourcePinterestSchemasValidEnums {
	if r == nil {
		return nil
	}
	return r.Columns
...
func (r *ReportConfig) GetConversionReportTime() *ConversionReportTime {
	if r == nil {
		return nil
	}
	return r.ConversionReportTime
}

func (r *ReportConfig) GetEngagementWindowDays() *EngagementWindowDays {
	if r == nil {
		return nil
	}
	return r.EngagementWindowDays
}

func (r *ReportConfig) GetGranularity() *Granularity {
	if r == nil {
		return nil
	}
...
func (r *ReportConfig) GetLevel() *SourcePinterestLevel {
	if r == nil {
		return nil
	}
	return r.Level
...
func (r *ReportConfig) GetName() string {
	if r == nil {
		return ""
	}
	return r.Name
...
func (r *ReportConfig) GetStartDate() *types.Date {
	if r == nil {
		return nil
	}
	return r.StartDate
...
func (r *ReportConfig) GetViewWindowDays() *ViewWindowDays {
	if r == nil {
		return nil
	}
	return r.ViewWindowDays
}
...
type SourcePinterestSourceType string

const (
	SourcePinterestSourceTypePinterest SourcePinterestSourceType = "pinterest"
)

func (e SourcePinterestSourceType) ToPointer() *SourcePinterestSourceType {
	return &e
}
func (e *SourcePinterestSourceType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "pinterest":
		*e = SourcePinterestSourceType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SourcePinterestSourceType: %v", v)
	}
}
...
func (s *SourcePinterest) GetAccountID() *string {
	if s == nil {
		return nil
	}
	return s.AccountID
...
func (s *SourcePinterest) GetCredentials() *OAuth20 {
	if s == nil {
		return nil
	}
...
func (s *SourcePinterest) GetCustomReports() []ReportConfig {
	if s == nil {
		return nil
	}
...
func (s *SourcePinterest) GetNumThreads() *int64 {
	if s == nil {
		return nil
	}
	return s.NumThreads
...
func (s *SourcePinterest) GetStartDate() *types.Date {
	if s == nil {
		return nil
	}
	return s.StartDate
...
func (s *SourcePinterest) GetStatus() []Status {
	if s == nil {
		return nil
	}
	return s.Status
...
func (s *SourcePinterest) GetSourceType() *SourcePinterestSourceType {
	return SourcePinterestSourceTypePinterest.ToPointer()
}

func (s *SourcePinterest) GetAdditionalProperties() any {
	if s == nil {
		return nil
	}

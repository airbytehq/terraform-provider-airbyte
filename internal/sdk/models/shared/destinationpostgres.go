...
type DestinationPostgresSSLModes struct {
	DestinationPostgresDisable    *DestinationPostgresDisable    `queryParam:"inline"`
	DestinationPostgresAllow      *DestinationPostgresAllow      `queryParam:"inline"`
	DestinationPostgresPrefer     *DestinationPostgresPrefer     `queryParam:"inline"`
	DestinationPostgresRequire    *DestinationPostgresRequire    `queryParam:"inline"`
	DestinationPostgresVerifyCa   *DestinationPostgresVerifyCa   `queryParam:"inline"`
	DestinationPostgresVerifyFull *DestinationPostgresVerifyFull `queryParam:"inline"`
...
type DestinationPostgresSSHTunnelMethod struct {
	DestinationPostgresNoTunnel               *DestinationPostgresNoTunnel               `queryParam:"inline"`
	DestinationPostgresSSHKeyAuthentication   *DestinationPostgresSSHKeyAuthentication   `queryParam:"inline"`
	DestinationPostgresPasswordAuthentication *DestinationPostgresPasswordAuthentication `queryParam:"inline"`
...
func (o *DestinationPostgres) GetUnconstrainedNumber() *bool {
	if o == nil {
		return nil
	}

...
// #region class-body-sourceshopifyupdateoauth20
// #endregion class-body-sourceshopifyupdateoauth20
...
func (s *SourceShopifyUpdate) GetFulfillmentOrdersIncludeClosed() *bool {
	if s == nil {
		return nil
	}

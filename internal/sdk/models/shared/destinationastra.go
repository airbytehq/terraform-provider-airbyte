...
func (a *AzureOpenAI) GetAPIBase() string {
	if a == nil {
		return ""
	}
	return a.APIBase
...
func (a *AzureOpenAI) GetDeployment() string {
	if a == nil {
		return ""
	}
	return a.Deployment
...
func (a *AzureOpenAI) GetMode() *DestinationAstraSchemasEmbeddingEmbeddingMode {
	return DestinationAstraSchemasEmbeddingEmbeddingModeAzureOpenai.ToPointer()
}

func (a *AzureOpenAI) GetOpenaiKey() string {
	if a == nil {
		return ""
	}
	return a.OpenaiKey
...
func (f *Fake) GetMode() *DestinationAstraSchemasEmbeddingMode {
...
func (c *Cohere) GetCohereKey() string {
	if c == nil {
		return ""
	}
	return c.CohereKey
...
func (c *Cohere) GetMode() *DestinationAstraSchemasMode {
...
type Embedding struct {
	OpenAI           *OpenAI           `queryParam:"inline" union:"member"`
	Cohere           *Cohere           `queryParam:"inline" union:"member"`
	Fake             *Fake             `queryParam:"inline" union:"member"`
	AzureOpenAI      *AzureOpenAI      `queryParam:"inline" union:"member"`
	OpenAICompatible *OpenAICompatible `queryParam:"inline" union:"member"`
...
func (u *Embedding) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &openAI, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  EmbeddingTypeOpenAI,
			Value: &openAI,
		})
	}

	var cohere Cohere = Cohere{}
	if err := utils.UnmarshalJSON(data, &cohere, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  EmbeddingTypeCohere,
			Value: &cohere,
		})
	}

	var fake Fake = Fake{}
	if err := utils.UnmarshalJSON(data, &fake, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  EmbeddingTypeFake,
			Value: &fake,
		})
	}

	var azureOpenAI AzureOpenAI = AzureOpenAI{}
	if err := utils.UnmarshalJSON(data, &azureOpenAI, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  EmbeddingTypeAzureOpenAI,
			Value: &azureOpenAI,
		})
	}

	var openAICompatible OpenAICompatible = OpenAICompatible{}
	if err := utils.UnmarshalJSON(data, &openAICompatible, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  EmbeddingTypeOpenAICompatible,
	...
	case EmbeddingTypeOpenAI:
		u.OpenAI = best.Value.(*OpenAI)
		return nil
	case EmbeddingTypeCohere:
		u.Cohere = best.Value.(*Cohere)
		return nil
	case EmbeddingTypeFake:
		u.Fake = best.Value.(*Fake)
		return nil
	case EmbeddingTypeAzureOpenAI:
		u.AzureOpenAI = best.Value.(*AzureOpenAI)
		return nil
	case EmbeddingTypeOpenAICompatible:
		u.OpenAICompatible = best.Value.(*OpenAICompatible)
		return nil
	}
...
func (i *Indexing) GetAstraDbAppToken() string {
	if i == nil {
		return ""
	}
	return i.AstraDbAppToken
}

func (i *Indexing) GetAstraDbEndpoint() string {
	if i == nil {
		return ""
	}
	return i.AstraDbEndpoint
}

func (i *Indexing) GetAstraDbKeyspace() string {
	if i == nil {
		return ""
	}
	return i.AstraDbKeyspace
}

func (i *Indexing) GetCollection() string {
	if i == nil {
		return ""
	}
	return i.Collection
...
func (f *FieldNameMappingConfigModel) GetFromField() string {
	if f == nil {
		return ""
	}
	return f.FromField
...
func (f *FieldNameMappingConfigModel) GetToField() string {
	if f == nil {
		return ""
	}
	return f.ToField
...
func (b *ByProgrammingLanguage) GetLanguage() DestinationAstraLanguage {
	if b == nil {
...
func (b *ByProgrammingLanguage) GetMode() *DestinationAstraSchemasProcessingTextSplitterTextSplitterMode {
...
func (b *ByMarkdownHeader) GetMode() *DestinationAstraSchemasProcessingTextSplitterMode {
	return DestinationAstraSchemasProcessingTextSplitterModeMarkdown.ToPointer()
}

func (b *ByMarkdownHeader) GetSplitLevel() *int64 {
	if b == nil {
		return nil
	}
	return b.SplitLevel
...
func (b *BySeparator) GetKeepSeparator() *bool {
	if b == nil {
		return nil
	}
	return b.KeepSeparator
}

func (b *BySeparator) GetMode() *DestinationAstraSchemasProcessingMode {
	return DestinationAstraSchemasProcessingModeSeparator.ToPointer()
}

func (b *BySeparator) GetSeparators() []string {
	if b == nil {
		return nil
	}
	return b.Separators
...
type TextSplitter struct {
	BySeparator           *BySeparator           `queryParam:"inline" union:"member"`
	ByMarkdownHeader      *ByMarkdownHeader      `queryParam:"inline" union:"member"`
	ByProgrammingLanguage *ByProgrammingLanguage `queryParam:"inline" union:"member"`
...
func (u *TextSplitter) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &bySeparator, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  TextSplitterTypeBySeparator,
			Value: &bySeparator,
		})
	}

	var byMarkdownHeader ByMarkdownHeader = ByMarkdownHeader{}
	if err := utils.UnmarshalJSON(data, &byMarkdownHeader, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  TextSplitterTypeByMarkdownHeader,
			Value: &byMarkdownHeader,
		})
	}

	var byProgrammingLanguage ByProgrammingLanguage = ByProgrammingLanguage{}
	if err := utils.UnmarshalJSON(data, &byProgrammingLanguage, "", true, nil); err == nil {
		candidates = append(candidates, utils.UnionCandidate{
			Type:  TextSplitterTypeByProgrammingLanguage,
			Value: &byProgrammingLanguage,
		})
	}
	...
	// Set the union type and value based on the best candidate
	u.Type = best.Type.(TextSplitterType)
	switch best.Type {
	case TextSplitterTypeBySeparator:
		u.BySeparator = best.Value.(*BySeparator)
		return nil
	case TextSplitterTypeByMarkdownHeader:
		u.ByMarkdownHeader = best.Value.(*ByMarkdownHeader)
		return nil
	case TextSplitterTypeByProgrammingLanguage:
		u.ByProgrammingLanguage = best.Value.(*ByProgrammingLanguage)
		return nil
	}
...
func (p *ProcessingConfigModel) GetChunkOverlap() *int64 {
	if p == nil {
		return nil
	}
...
func (p *ProcessingConfigModel) GetChunkSize() int64 {
	if p == nil {
		return 0
	}
	return p.ChunkSize
...
func (p *ProcessingConfigModel) GetFieldNameMappings() []FieldNameMappingConfigModel {
	if p == nil {
		return nil
	}
	return p.FieldNameMappings
}

func (p *ProcessingConfigModel) GetMetadataFields() []string {
	if p == nil {
		return nil
	}
	return p.MetadataFields
}

func (p *ProcessingConfigModel) GetTextFields() []string {
	if p == nil {
		return nil
	}
	return p.TextFields
...
func (p *ProcessingConfigModel) GetTextSplitter() *TextSplitter {
	if p == nil {
		return nil
	}
	return p.TextSplitter
}

type DestinationType string

const (
	DestinationTypeAstra DestinationType = "astra"
)
...
type DestinationAstra struct {
	...
	destinationType *DestinationType      `const:"astra" json:"destinationType"`
}
...
func (d *DestinationAstra) GetEmbedding() Embedding {
	if d == nil {
		return Embedding{}
	}
	return d.Embedding
...
func (d *DestinationAstra) GetIndexing() Indexing {
	if d == nil {
		return Indexing{}
	}
	return d.Indexing
...
func (d *DestinationAstra) GetOmitRawText() *bool {
	if d == nil {
		return nil
	}
...
func (d *DestinationAstra) GetProcessing() ProcessingConfigModel {
	if d == nil {
...
func (d *DestinationAstra) GetDestinationType() *DestinationType {
	return DestinationTypeAstra.ToPointer()
}

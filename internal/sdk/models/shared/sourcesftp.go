...
type SourceSftpAuthentication struct {
	SourceSftpPasswordAuthentication *SourceSftpPasswordAuthentication `queryParam:"inline"`
	SourceSftpSSHKeyAuthentication   *SourceSftpSSHKeyAuthentication   `queryParam:"inline"`

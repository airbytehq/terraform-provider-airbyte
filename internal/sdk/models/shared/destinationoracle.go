...
const (
	DestinationOracleSchemasEncryptionMethodEncryptedVerifyCertificate DestinationOracleSchemasEncryptionMethod = "encrypted_verify_certificate"
)
...
type DestinationOracleTLSEncryptedVerifyCertificate struct {
	...
	encryptionMethod *DestinationOracleSchemasEncryptionMethod `const:"encrypted_verify_certificate" json:"encryption_method"`
...
func (d *DestinationOracleTLSEncryptedVerifyCertificate) GetEncryptionMethod() *DestinationOracleSchemasEncryptionMethod {
	return DestinationOracleSchemasEncryptionMethodEncryptedVerifyCertificate.ToPointer()
}
...
const (
	DestinationOracleEncryptionMethodClientNne DestinationOracleEncryptionMethod = "client_nne"
)
...
type DestinationOracleNativeNetworkEncryptionNNE struct {
	...
	//lint:ignore U1000 accessed via reflection for JSON marshaling
	encryptionMethod *DestinationOracleEncryptionMethod `const:"client_nne" json:"encryption_method"`
}
...
func (d *DestinationOracleNativeNetworkEncryptionNNE) GetEncryptionMethod() *DestinationOracleEncryptionMethod {
	return DestinationOracleEncryptionMethodClientNne.ToPointer()
}
...
func (d *DestinationOracleUnencrypted) GetEncryptionMethod() *EncryptionMethod {

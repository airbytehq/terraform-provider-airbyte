...
type DestinationDynamodbDestinationType string

const (
	DestinationDynamodbDestinationTypeDynamodb DestinationDynamodbDestinationType = "dynamodb"
)

func (e DestinationDynamodbDestinationType) ToPointer() *DestinationDynamodbDestinationType {
	return &e
}
func (e *DestinationDynamodbDestinationType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "dynamodb":
		*e = DestinationDynamodbDestinationType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DestinationDynamodbDestinationType: %v", v)
	}
}
...
type DestinationDynamodb struct {
	...
	destinationType *DestinationDynamodbDestinationType `const:"dynamodb" json:"destinationType"`
}
...
func (d *DestinationDynamodb) GetAccessKeyID() string {
	if d == nil {
		return ""
	}
...
func (d *DestinationDynamodb) GetDynamodbEndpoint() *string {
	if d == nil {
		return nil
	}
...
func (d *DestinationDynamodb) GetDynamodbRegion() *DestinationDynamodbDynamoDBRegion {
	if d == nil {
		return nil
	}
...
func (d *DestinationDynamodb) GetDynamodbTableNamePrefix() string {
	if d == nil {
		return ""
	}
...
func (d *DestinationDynamodb) GetSecretAccessKey() string {
	if d == nil {
		return ""
	}
...
func (d *DestinationDynamodb) GetDestinationType() *DestinationDynamodbDestinationType {
	return DestinationDynamodbDestinationTypeDynamodb.ToPointer()
}

...
type DestinationMilvusEmbedding struct {
	DestinationMilvusOpenAI           *DestinationMilvusOpenAI           `queryParam:"inline"`
	DestinationMilvusCohere           *DestinationMilvusCohere           `queryParam:"inline"`
	DestinationMilvusFake             *DestinationMilvusFake             `queryParam:"inline"`
	DestinationMilvusAzureOpenAI      *DestinationMilvusAzureOpenAI      `queryParam:"inline"`
	DestinationMilvusOpenAICompatible *DestinationMilvusOpenAICompatible `queryParam:"inline"`
...
func (o *NoAuth) GetMode() *DestinationMilvusSchemasIndexingAuthAuthenticationMode {
...
type DestinationMilvusAuthentication struct {
	DestinationMilvusAPIToken         *DestinationMilvusAPIToken         `queryParam:"inline"`
	DestinationMilvusUsernamePassword *DestinationMilvusUsernamePassword `queryParam:"inline"`
	NoAuth                            *NoAuth                            `queryParam:"inline"`

...
const (
	...
	PokemonNameNidoranF     PokemonName = "nidoran-f"
	PokemonNameNidorina     PokemonName = "nidorina"
	PokemonNameNidoqueen    PokemonName = "nidoqueen"
	PokemonNameNidoranM     PokemonName = "nidoran-m"
...
type SourcePokeapiSourceType string

const (
	SourcePokeapiSourceTypePokeapi SourcePokeapiSourceType = "pokeapi"
)

func (e SourcePokeapiSourceType) ToPointer() *SourcePokeapiSourceType {
	return &e
}
func (e *SourcePokeapiSourceType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "pokeapi":
		*e = SourcePokeapiSourceType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SourcePokeapiSourceType: %v", v)
	}
}
...
type SourcePokeapi struct {
	...
	sourceType           *SourcePokeapiSourceType `const:"pokeapi" json:"sourceType"`
...
func (s *SourcePokeapi) GetPokemonName() PokemonName {
	if s == nil {
		return PokemonName("")
	}
...
func (s *SourcePokeapi) GetSourceType() *SourcePokeapiSourceType {
	return SourcePokeapiSourceTypePokeapi.ToPointer()
}

func (s *SourcePokeapi) GetAdditionalProperties() any {
	if s == nil {
		return nil
	}

...
type SourceNewsdataSourceType string

const (
	SourceNewsdataSourceTypeNewsdata SourceNewsdataSourceType = "newsdata"
)

func (e SourceNewsdataSourceType) ToPointer() *SourceNewsdataSourceType {
	return &e
}
func (e *SourceNewsdataSourceType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "newsdata":
		*e = SourceNewsdataSourceType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SourceNewsdataSourceType: %v", v)
	}
}
...
type SourceNewsdata struct {
	...
	sourceType           *SourceNewsdataSourceType `const:"newsdata" json:"sourceType"`
...
func (s *SourceNewsdata) GetOneOf() any {
	if s == nil {
		return nil
	}
	return s.OneOf
...
func (s *SourceNewsdata) GetAPIKey() string {
	if s == nil {
		return ""
	}
	return s.APIKey
...
func (s *SourceNewsdata) GetCategory() []SourceNewsdataCategory {
	if s == nil {
		return nil
	}
	return s.Category
...
func (s *SourceNewsdata) GetCountry() []SourceNewsdataCountry {
	if s == nil {
		return nil
	}
	return s.Country
...
func (s *SourceNewsdata) GetDomain() []string {
	if s == nil {
		return nil
	}
	return s.Domain
...
func (s *SourceNewsdata) GetLanguage() []SourceNewsdataLanguage {
	if s == nil {
		return nil
	}
	return s.Language
...
func (s *SourceNewsdata) GetSourceType() *SourceNewsdataSourceType {
	return SourceNewsdataSourceTypeNewsdata.ToPointer()
}

func (s *SourceNewsdata) GetAdditionalProperties() any {
	if s == nil {
		return nil
	}

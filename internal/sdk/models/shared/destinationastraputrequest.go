...
func (d *DestinationAstraPutRequest) GetName() string {
	if d == nil {
		return ""
	}
	return d.Name
...
func (d *DestinationAstraPutRequest) GetWorkspaceID() string {
	if d == nil {
		return ""
	}
...
func (d *DestinationAstraPutRequest) GetConfiguration() DestinationAstraUpdate {
	if d == nil {

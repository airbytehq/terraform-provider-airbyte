...
type DestinationSnowflakeCortexUpdateEmbedding struct {
	DestinationSnowflakeCortexUpdateOpenAI           *DestinationSnowflakeCortexUpdateOpenAI           `queryParam:"inline"`
	DestinationSnowflakeCortexUpdateCohere           *DestinationSnowflakeCortexUpdateCohere           `queryParam:"inline"`
	DestinationSnowflakeCortexUpdateFake             *DestinationSnowflakeCortexUpdateFake             `queryParam:"inline"`
	DestinationSnowflakeCortexUpdateAzureOpenAI      *DestinationSnowflakeCortexUpdateAzureOpenAI      `queryParam:"inline"`
	DestinationSnowflakeCortexUpdateOpenAICompatible *DestinationSnowflakeCortexUpdateOpenAICompatible `queryParam:"inline"`
...
type DestinationSnowflakeCortexUpdateTextSplitter struct {
	DestinationSnowflakeCortexUpdateBySeparator           *DestinationSnowflakeCortexUpdateBySeparator           `queryParam:"inline"`
	DestinationSnowflakeCortexUpdateByMarkdownHeader      *DestinationSnowflakeCortexUpdateByMarkdownHeader      `queryParam:"inline"`
	DestinationSnowflakeCortexUpdateByProgrammingLanguage *DestinationSnowflakeCortexUpdateByProgrammingLanguage `queryParam:"inline"`

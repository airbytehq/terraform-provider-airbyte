...
func newPublicRoot(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PublicRoot {
	return &PublicRoot{
		rootSDK:          rootSDK,
...
func (s *PublicRoot) GetDocumentation(ctx context.Context, opts ...operations.Option) (*operations.GetDocumentationResponse, error) {

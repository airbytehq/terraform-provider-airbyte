...
func TrustRead() planmodifier.Object {
	return trustRead{}
}
...
func (m trustRead) PlanModifyObject(ctx context.Context, req planmodifier.ObjectRequest, resp *planmodifier.ObjectResponse) {

...
func (r *SourceMendeleyResourceModel) ToSharedSourceMendeleyCreateRequest() *shared.SourceMendeleyCreateRequest {
	var name string
...
func (r *SourceMendeleyResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourceMendeleyResourceModel) ToSharedSourceMendeleyPutRequest() *shared.SourceMendeleyPutRequest {
	var name string
	name = r.Name.ValueString()

...
type SourceGoogleAnalyticsDataAPICredentials struct {
	...
	SourceGoogleAnalyticsDataAPIUpdateCredentialsAuthenticateViaGoogleOauth      *SourceGoogleAnalyticsDataAPICredentialsAuthenticateViaGoogleOauth      `tfsdk:"source_google_analytics_data_api_update_credentials_authenticate_via_google_oauth_"`

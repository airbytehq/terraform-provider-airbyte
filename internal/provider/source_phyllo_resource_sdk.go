...
func (r *SourcePhylloResourceModel) ToSharedSourcePhylloCreateRequest() *shared.SourcePhylloCreateRequest {
	var name string
...
func (r *SourcePhylloResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourcePhylloResourceModel) ToSharedSourcePhylloPutRequest() *shared.SourcePhylloPutRequest {
	var name string
	name = r.Name.ValueString()

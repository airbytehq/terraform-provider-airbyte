...
func (r *SourceGetlagoDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
...
func (r *SourceGetlagoDataSourceModel) ToOperationsGetSourceGetlagoRequest(ctx context.Context) (*operations.GetSourceGetlagoRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

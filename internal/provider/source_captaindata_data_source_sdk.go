...
func (r *SourceCaptainDataDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
...
func (r *SourceCaptainDataDataSourceModel) ToOperationsGetSourceCaptainDataRequest(ctx context.Context) (*operations.GetSourceCaptainDataRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

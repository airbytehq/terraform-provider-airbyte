...
func (r *SourceSparkpostResourceModel) ToSharedSourceSparkpostCreateRequest() *shared.SourceSparkpostCreateRequest {
	var name string
...
func (r *SourceSparkpostResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourceSparkpostResourceModel) ToSharedSourceSparkpostPutRequest() *shared.SourceSparkpostPutRequest {
	var name string
	name = r.Name.ValueString()

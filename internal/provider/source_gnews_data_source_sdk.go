...
func (r *SourceGnewsDataSourceModel) ToOperationsGetSourceGnewsRequest(ctx context.Context) (*operations.GetSourceGnewsRequest, diag.Diagnostics) {
...
func (r *SourceGnewsDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
	var diags diag.Diagnostics

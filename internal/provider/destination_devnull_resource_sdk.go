...
func (r *DestinationDevNullResourceModel) ToSharedDestinationDevNullPutRequest(ctx context.Context) (*shared.DestinationDevNullPutRequest, diag.Diagnostics) {
	...
	if r.Configuration.TestDestination.Logging != nil {
		...
		if r.Configuration.TestDestination.Logging.LoggingConfig.EveryNThEntry != nil {
			...
			nthEntryToLog := new(int64)
			if !r.Configuration.TestDestination.Logging.LoggingConfig.EveryNThEntry.NthEntryToLog.IsUnknown() && !r.Configuration.TestDestination.Logging.LoggingConfig.EveryNThEntry.NthEntryToLog.IsNull() {
				*nthEntryToLog = r.Configuration.TestDestination.Logging.LoggingConfig.EveryNThEntry.NthEntryToLog.ValueInt64()
			} else {
				nthEntryToLog = nil
			}
	...
	if r.Configuration.TestDestination.Throttled != nil {
		millisPerRecord := new(int64)
		if !r.Configuration.TestDestination.Throttled.MillisPerRecord.IsUnknown() && !r.Configuration.TestDestination.Throttled.MillisPerRecord.IsNull() {
			*millisPerRecord = r.Configuration.TestDestination.Throttled.MillisPerRecord.ValueInt64()
		} else {
			millisPerRecord = nil
		}
	...
	if r.Configuration.TestDestination.Failing != nil {
		numMessages := new(int64)
		if !r.Configuration.TestDestination.Failing.NumMessages.IsUnknown() && !r.Configuration.TestDestination.Failing.NumMessages.IsNull() {
			*numMessages = r.Configuration.TestDestination.Failing.NumMessages.ValueInt64()
		} else {
			numMessages = nil
		}

...
func (r *SourceYousignResourceModel) ToSharedSourceYousignCreateRequest() *shared.SourceYousignCreateRequest {
	var name string
...
func (r *SourceYousignResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourceYousignResourceModel) ToSharedSourceYousignPutRequest() *shared.SourceYousignPutRequest {
	var name string
	name = r.Name.ValueString()

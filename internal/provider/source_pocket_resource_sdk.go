...
func (r *SourcePocketResourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
	...
	if resp != nil {
		...
		if configurationPriorData != nil {
			...
			r.Configuration.ContentType = configurationPriorData.ContentType
			r.Configuration.DetailType = configurationPriorData.DetailType
			r.Configuration.Domain = configurationPriorData.Domain
			r.Configuration.Favorite = configurationPriorData.Favorite

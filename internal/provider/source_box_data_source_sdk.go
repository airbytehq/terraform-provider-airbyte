...
func (r *SourceBoxDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
...
func (r *SourceBoxDataSourceModel) ToOperationsGetSourceBoxRequest(ctx context.Context) (*operations.GetSourceBoxRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

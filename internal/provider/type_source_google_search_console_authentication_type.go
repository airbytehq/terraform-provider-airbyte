...
type SourceGoogleSearchConsoleAuthenticationType struct {
	SourceGoogleSearchConsoleAuthenticationTypeOAuth                                 *SourceGoogleAnalyticsDataAPICredentialsAuthenticateViaGoogleOauth          `tfsdk:"source_google_search_console_authentication_type_o_auth"`
	...
	SourceGoogleSearchConsoleUpdateAuthenticationTypeOAuth                           *SourceGoogleAnalyticsDataAPICredentialsAuthenticateViaGoogleOauth          `tfsdk:"source_google_search_console_update_authentication_type_o_auth"`

...
func (r *SourceCimisDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
...
func (r *SourceCimisDataSourceModel) ToOperationsGetSourceCimisRequest(ctx context.Context) (*operations.GetSourceCimisRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

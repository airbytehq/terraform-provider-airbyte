...
func (r *SourceEbayFinanceResourceModel) ToSharedSourceEbayFinanceCreateRequest() *shared.SourceEbayFinanceCreateRequest {
	var name string
...
func (r *SourceEbayFinanceResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourceEbayFinanceResourceModel) ToSharedSourceEbayFinancePutRequest() *shared.SourceEbayFinancePutRequest {
	var name string
	name = r.Name.ValueString()

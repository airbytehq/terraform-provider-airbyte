...
type DestinationDatabricksDataSource2 struct {
	DestinationDatabricksDataSourceRecommendedManagedTables       *DestinationAzureBlobStorageOutputFormatJSONLinesNewlineDelimitedJSON `tfsdk:"destination_databricks_data_source_recommended_managed_tables"`
	...
	DestinationDatabricksUpdateDataSourceRecommendedManagedTables *DestinationAzureBlobStorageOutputFormatJSONLinesNewlineDelimitedJSON `tfsdk:"destination_databricks_update_data_source_recommended_managed_tables"`

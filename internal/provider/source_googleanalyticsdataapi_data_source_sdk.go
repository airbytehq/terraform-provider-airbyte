...
func (r *SourceGoogleAnalyticsDataAPIDataSourceModel) ToOperationsGetSourceGoogleAnalyticsDataAPIRequest(ctx context.Context) (*operations.GetSourceGoogleAnalyticsDataAPIRequest, diag.Diagnostics) {
...
func (r *SourceGoogleAnalyticsDataAPIDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
	var diags diag.Diagnostics

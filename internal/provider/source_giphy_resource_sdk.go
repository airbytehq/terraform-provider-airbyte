...
func (r *SourceGiphyResourceModel) ToSharedSourceGiphyCreateRequest() *shared.SourceGiphyCreateRequest {
	var name string
...
func (r *SourceGiphyResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourceGiphyResourceModel) ToSharedSourceGiphyPutRequest() *shared.SourceGiphyPutRequest {
	var name string
	name = r.Name.ValueString()

...
func (r *SourceCartDataSourceModel) ToOperationsGetSourceCartRequest(ctx context.Context) (*operations.GetSourceCartRequest, diag.Diagnostics) {
...
func (r *SourceCartDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
	var diags diag.Diagnostics

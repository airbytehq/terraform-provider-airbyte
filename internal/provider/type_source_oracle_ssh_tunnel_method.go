...
type SourceOracleSSHTunnelMethod struct {
	SourceOracleSSHTunnelMethodNoTunnel                     *DestinationAzureBlobStorageOutputFormatJSONLinesNewlineDelimitedJSON `tfsdk:"source_oracle_ssh_tunnel_method_no_tunnel"`
	...
	SourceOracleUpdateSSHTunnelMethodNoTunnel               *DestinationAzureBlobStorageOutputFormatJSONLinesNewlineDelimitedJSON `tfsdk:"source_oracle_update_ssh_tunnel_method_no_tunnel"`

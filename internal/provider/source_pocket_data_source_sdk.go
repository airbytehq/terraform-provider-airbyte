...
func (r *SourcePocketDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
...
func (r *SourcePocketDataSourceModel) ToOperationsGetSourcePocketRequest(ctx context.Context) (*operations.GetSourcePocketRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

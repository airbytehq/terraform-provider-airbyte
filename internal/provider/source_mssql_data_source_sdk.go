...
func (r *SourceMssqlDataSourceModel) ToOperationsGetSourceMssqlRequest(ctx context.Context) (*operations.GetSourceMssqlRequest, diag.Diagnostics) {
...
func (r *SourceMssqlDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
	var diags diag.Diagnostics

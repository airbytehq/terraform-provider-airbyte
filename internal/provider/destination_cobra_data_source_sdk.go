...
func (r *DestinationCobraDataSourceModel) ToOperationsGetDestinationCobraRequest(ctx context.Context) (*operations.GetDestinationCobraRequest, diag.Diagnostics) {
...
func (r *DestinationCobraDataSourceModel) RefreshFromSharedDestinationResponse(ctx context.Context, resp *shared.DestinationResponse) diag.Diagnostics {
	var diags diag.Diagnostics

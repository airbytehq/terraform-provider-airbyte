...
func (r *DestinationResourceModel) RefreshFromSharedDestinationResponse(ctx context.Context, resp *shared.DestinationResponse) diag.Diagnostics {
	var diags diag.Diagnostics

	if resp != nil {
		r.Configuration = &tfTypes.DestinationConfiguration{}
...
func (r *DestinationResourceModel) ToOperationsDeleteDestinationRequest(ctx context.Context) (*operations.DeleteDestinationRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

	var destinationID string
	destinationID = r.DestinationID.ValueString()

	out := operations.DeleteDestinationRequest{
...
func (r *DestinationResourceModel) ToOperationsGetDestinationRequest(ctx context.Context) (*operations.GetDestinationRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

	var destinationID string
	destinationID = r.DestinationID.ValueString()

	out := operations.GetDestinationRequest{
		DestinationID: destinationID,
	}
...
func (r *DestinationResourceModel) ToOperationsPutDestinationRequest(ctx context.Context) (*operations.PutDestinationRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

	var destinationID string
	destinationID = r.DestinationID.ValueString()

	destinationPutRequest, destinationPutRequestDiags := r.ToSharedDestinationPutRequest(ctx)
	diags.Append(destinationPutRequestDiags...)

	if diags.HasError() {
		return nil, diags
	}

	out := operations.PutDestinationRequest{
		DestinationID:         destinationID,
...
func (r *DestinationResourceModel) ToSharedDestinationCreateRequest(ctx context.Context) (*shared.DestinationCreateRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *DestinationResourceModel) ToSharedDestinationPutRequest(ctx context.Context) (*shared.DestinationPutRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := shared.DestinationPutRequest{
		Name:               name,
		Configuration:      configuration,
		ResourceAllocation: resourceAllocation,
	}

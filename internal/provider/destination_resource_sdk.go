...
func (r *DestinationResourceModel) ToCreateSDKType() *shared.DestinationCreateRequest {
	...
	if r.Configuration.DestinationS3Glue != nil {
		...
		if r.Configuration.DestinationS3Glue.Format.DestinationS3GlueOutputFormatJSONLinesNewlineDelimitedJSON != nil {
			...
			flattening4 := new(shared.DestinationS3GlueOutputFormatJSONLinesNewlineDelimitedJSONFlatteningEnum)
			if !r.Configuration.DestinationS3Glue.Format.DestinationS3GlueOutputFormatJSONLinesNewlineDelimitedJSON.Flattening.IsUnknown() && !r.Configuration.DestinationS3Glue.Format.DestinationS3GlueOutputFormatJSONLinesNewlineDelimitedJSON.Flattening.IsNull() {
				*flattening4 = shared.DestinationS3GlueOutputFormatJSONLinesNewlineDelimitedJSONFlatteningEnum(r.Configuration.DestinationS3Glue.Format.DestinationS3GlueOutputFormatJSONLinesNewlineDelimitedJSON.Flattening.ValueString())
			} else {
				flattening4 = nil
			}
...
func (r *DestinationResourceModel) RefreshFromCreateResponse(resp *shared.DestinationResponse) {

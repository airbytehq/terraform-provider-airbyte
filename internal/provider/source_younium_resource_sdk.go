...
func (r *SourceYouniumResourceModel) ToSharedSourceYouniumCreateRequest() *shared.SourceYouniumCreateRequest {
	var name string
...
func (r *SourceYouniumResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourceYouniumResourceModel) ToSharedSourceYouniumPutRequest() *shared.SourceYouniumPutRequest {
	var name string
	name = r.Name.ValueString()

...
type DestinationS3OutputFormat struct {
	...
	DestinationS3OutputFormatParquetColumnarStorage              *DestinationGcsOutputFormatParquetColumnarStorage             `tfsdk:"destination_s3_output_format_parquet_columnar_storage"`
	...
	DestinationS3UpdateOutputFormatParquetColumnarStorage        *DestinationGcsOutputFormatParquetColumnarStorage             `tfsdk:"destination_s3_update_output_format_parquet_columnar_storage"`
}

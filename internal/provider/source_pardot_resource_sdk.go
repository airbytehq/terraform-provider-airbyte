...
func (r *SourcePardotResourceModel) ToSharedSourcePardotCreateRequest() *shared.SourcePardotCreateRequest {
	var name string
...
func (r *SourcePardotResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourcePardotResourceModel) ToSharedSourcePardotPutRequest() *shared.SourcePardotPutRequest {
	var name string
	name = r.Name.ValueString()

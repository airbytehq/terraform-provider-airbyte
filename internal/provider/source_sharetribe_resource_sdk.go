...
func (r *SourceSharetribeResourceModel) ToSharedSourceSharetribeCreateRequest() *shared.SourceSharetribeCreateRequest {
	var name string
...
func (r *SourceSharetribeResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourceSharetribeResourceModel) ToSharedSourceSharetribePutRequest() *shared.SourceSharetribePutRequest {
	var name string
	name = r.Name.ValueString()

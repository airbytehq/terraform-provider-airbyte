...
func (r *SourceKafkaDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
...
func (r *SourceKafkaDataSourceModel) ToOperationsGetSourceKafkaRequest(ctx context.Context) (*operations.GetSourceKafkaRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

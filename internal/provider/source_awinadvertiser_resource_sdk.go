...
func (r *SourceAwinAdvertiserResourceModel) ToSharedSourceAwinAdvertiserCreateRequest() *shared.SourceAwinAdvertiserCreateRequest {
	var name string
...
func (r *SourceAwinAdvertiserResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourceAwinAdvertiserResourceModel) ToSharedSourceAwinAdvertiserPutRequest() *shared.SourceAwinAdvertiserPutRequest {
	var name string
	name = r.Name.ValueString()

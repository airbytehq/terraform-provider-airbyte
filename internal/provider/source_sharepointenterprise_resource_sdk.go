...
func (r *SourceSharepointEnterpriseResourceModel) ToSharedSourceSharepointEnterpriseCreateRequest() *shared.SourceSharepointEnterpriseCreateRequest {
	var name string
...
func (r *SourceSharepointEnterpriseResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourceSharepointEnterpriseResourceModel) ToSharedSourceSharepointEnterprisePutRequest() *shared.SourceSharepointEnterprisePutRequest {
	var name string
	name = r.Name.ValueString()

...
func (r *SourceRssDataSourceModel) ToOperationsGetSourceRssRequest(ctx context.Context) (*operations.GetSourceRssRequest, diag.Diagnostics) {
...
func (r *SourceRssDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
	var diags diag.Diagnostics

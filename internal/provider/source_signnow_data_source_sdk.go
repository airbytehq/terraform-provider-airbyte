...
func (r *SourceSignnowDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
...
func (r *SourceSignnowDataSourceModel) ToOperationsGetSourceSignnowRequest(ctx context.Context) (*operations.GetSourceSignnowRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

...
func (r *SourceOrbDataSourceModel) ToOperationsGetSourceOrbRequest(ctx context.Context) (*operations.GetSourceOrbRequest, diag.Diagnostics) {
...
func (r *SourceOrbDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
	var diags diag.Diagnostics

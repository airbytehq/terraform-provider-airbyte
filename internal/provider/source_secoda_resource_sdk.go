...
func (r *SourceSecodaResourceModel) RefreshFromGetResponse(resp *shared.SourceSecodaGetResponse) {
...
func (r *SourceSecodaResourceModel) RefreshFromCreateResponse(resp *shared.SourceSecodaGetResponse) {

...
func (r *SourceConvertkitDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
...
func (r *SourceConvertkitDataSourceModel) ToOperationsGetSourceConvertkitRequest(ctx context.Context) (*operations.GetSourceConvertkitRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

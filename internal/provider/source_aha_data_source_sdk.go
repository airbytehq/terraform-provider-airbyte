...
func (r *SourceAhaDataSourceModel) ToOperationsGetSourceAhaRequest(ctx context.Context) (*operations.GetSourceAhaRequest, diag.Diagnostics) {
...
func (r *SourceAhaDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
	var diags diag.Diagnostics

...
type SourceGoogleDirectoryGoogleCredentials struct {
	...
	SourceGoogleDirectoryGoogleCredentialsSignInViaGoogleOAuth       *DestinationGoogleSheetsAuthenticationViaGoogleOAuth     `tfsdk:"source_google_directory_google_credentials_sign_in_via_google_o_auth"`
	...
	SourceGoogleDirectoryUpdateGoogleCredentialsSignInViaGoogleOAuth *DestinationGoogleSheetsAuthenticationViaGoogleOAuth     `tfsdk:"source_google_directory_update_google_credentials_sign_in_via_google_o_auth"`
}

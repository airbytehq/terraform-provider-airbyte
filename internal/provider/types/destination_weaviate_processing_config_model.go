...
type DestinationWeaviateProcessingConfigModel struct {
	...
	FieldNameMappings []DestinationWeaviateFieldNameMappingConfigModel `tfsdk:"field_name_mappings"`
	MetadataFields    []types.String                                   `tfsdk:"metadata_fields"`
	TextFields        []types.String                                   `tfsdk:"text_fields"`
	TextSplitter      *DestinationWeaviateTextSplitter                 `tfsdk:"text_splitter"`
}

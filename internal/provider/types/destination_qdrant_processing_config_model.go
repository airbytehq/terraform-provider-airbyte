...
type DestinationQdrantProcessingConfigModel struct {
	...
	FieldNameMappings []DestinationQdrantFieldNameMappingConfigModel `tfsdk:"field_name_mappings"`
	MetadataFields    []types.String                                 `tfsdk:"metadata_fields"`
	TextFields        []types.String                                 `tfsdk:"text_fields"`
	TextSplitter      *DestinationQdrantTextSplitter                 `tfsdk:"text_splitter"`
}

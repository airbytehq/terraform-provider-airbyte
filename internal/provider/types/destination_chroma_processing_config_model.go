...
type DestinationChromaProcessingConfigModel struct {
	...
	FieldNameMappings []DestinationChromaFieldNameMappingConfigModel `tfsdk:"field_name_mappings"`
	MetadataFields    []types.String                                 `tfsdk:"metadata_fields"`
	TextFields        []types.String                                 `tfsdk:"text_fields"`
	TextSplitter      *DestinationChromaTextSplitter                 `tfsdk:"text_splitter"`
}

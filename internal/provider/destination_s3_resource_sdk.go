...
func (r *DestinationS3ResourceModel) RefreshFromSharedDestinationResponse(ctx context.Context, resp *shared.DestinationResponse) diag.Diagnostics {
...
func (r *DestinationS3ResourceModel) ToOperationsDeleteDestinationS3Request(ctx context.Context) (*operations.DeleteDestinationS3Request, diag.Diagnostics) {
	var diags diag.Diagnostics

	var destinationID string
	destinationID = r.DestinationID.ValueString()

	out := operations.DeleteDestinationS3Request{
...
func (r *DestinationS3ResourceModel) ToOperationsGetDestinationS3Request(ctx context.Context) (*operations.GetDestinationS3Request, diag.Diagnostics) {
	var diags diag.Diagnostics

	var destinationID string
	destinationID = r.DestinationID.ValueString()

	out := operations.GetDestinationS3Request{
		DestinationID: destinationID,
	}
...
func (r *DestinationS3ResourceModel) ToOperationsPutDestinationS3Request(ctx context.Context) (*operations.PutDestinationS3Request, diag.Diagnostics) {
	var diags diag.Diagnostics

	var destinationID string
	destinationID = r.DestinationID.ValueString()

	destinationS3PutRequest, destinationS3PutRequestDiags := r.ToSharedDestinationS3PutRequest(ctx)
	diags.Append(destinationS3PutRequestDiags...)

	if diags.HasError() {
		return nil, diags
	}

	out := operations.PutDestinationS3Request{
		DestinationID:           destinationID,
...
func (r *DestinationS3ResourceModel) ToSharedDestinationS3CreateRequest(ctx context.Context) (*shared.DestinationS3CreateRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if r.Configuration.Format.AvroApacheAvro != nil {
		...
		var additionalProperties12 map[string]any
	...
	if r.Configuration.Format.ParquetColumnarStorage != nil {
		...
		var additionalProperties13 map[string]any
	...
	var additionalProperties14 map[string]any
	if !r.Configuration.AdditionalProperties.IsUnknown() && !r.Configuration.AdditionalProperties.IsNull() {
		_ = json.Unmarshal([]byte(r.Configuration.AdditionalProperties.ValueString()), &additionalProperties14)
	}
...
func (r *DestinationS3ResourceModel) ToSharedDestinationS3PutRequest(ctx context.Context) (*shared.DestinationS3PutRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

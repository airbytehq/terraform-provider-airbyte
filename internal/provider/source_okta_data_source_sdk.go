...
func (r *SourceOktaDataSourceModel) ToOperationsGetSourceOktaRequest(ctx context.Context) (*operations.GetSourceOktaRequest, diag.Diagnostics) {
...
func (r *SourceOktaDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
	var diags diag.Diagnostics

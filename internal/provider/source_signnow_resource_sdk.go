...
func (r *SourceSignnowResourceModel) ToSharedSourceSignnowCreateRequest() *shared.SourceSignnowCreateRequest {
	var name string
...
func (r *SourceSignnowResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourceSignnowResourceModel) ToSharedSourceSignnowPutRequest() *shared.SourceSignnowPutRequest {
	var name string
	name = r.Name.ValueString()

...
var _ datasource.DataSource = &DestinationAmazonSqsDataSource{}
var _ datasource.DataSourceWithConfigure = &DestinationAmazonSqsDataSource{}

func NewDestinationAmazonSqsDataSource() datasource.DataSource {
	return &DestinationAmazonSqsDataSource{}
}

// DestinationAmazonSqsDataSource is the data source implementation.
type DestinationAmazonSqsDataSource struct {
	client *sdk.SDK
}

// DestinationAmazonSqsDataSourceModel describes the data model.
type DestinationAmazonSqsDataSourceModel struct {
...
func (r *DestinationAmazonSqsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_destination_amazon_sqs"
}

// Schema defines the schema for the data source.
func (r *DestinationAmazonSqsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "DestinationAmazonSqs DataSource",
...
func (r *DestinationAmazonSqsDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *DestinationAmazonSqsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *DestinationAmazonSqsDataSourceModel

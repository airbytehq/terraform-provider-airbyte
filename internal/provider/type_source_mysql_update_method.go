...
type SourceMysqlUpdateMethod struct {
	...
	SourceMysqlUpdateMethodScanChangesWithUserDefinedCursor       *SourceMysqlUpdateMethodScanChangesWithUserDefinedCursor `tfsdk:"source_mysql_update_method_scan_changes_with_user_defined_cursor"`
	...
	SourceMysqlUpdateUpdateMethodScanChangesWithUserDefinedCursor *SourceMysqlUpdateMethodScanChangesWithUserDefinedCursor `tfsdk:"source_mysql_update_update_method_scan_changes_with_user_defined_cursor"`
}

...
func (r *SourceMissiveResourceModel) ToSharedSourceMissiveCreateRequest() *shared.SourceMissiveCreateRequest {
	var name string
...
func (r *SourceMissiveResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourceMissiveResourceModel) ToSharedSourceMissivePutRequest() *shared.SourceMissivePutRequest {
	var name string
	name = r.Name.ValueString()

...
func (r *SourceK6CloudDataSourceModel) ToOperationsGetSourceK6CloudRequest(ctx context.Context) (*operations.GetSourceK6CloudRequest, diag.Diagnostics) {
...
func (r *SourceK6CloudDataSourceModel) RefreshFromSharedSourceResponse(ctx context.Context, resp *shared.SourceResponse) diag.Diagnostics {
	var diags diag.Diagnostics

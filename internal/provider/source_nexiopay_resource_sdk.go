...
func (r *SourceNexiopayResourceModel) ToSharedSourceNexiopayCreateRequest() *shared.SourceNexiopayCreateRequest {
	var name string
...
func (r *SourceNexiopayResourceModel) RefreshFromSharedSourceResponse(resp *shared.SourceResponse) {
	if resp != nil {
...
func (r *SourceNexiopayResourceModel) ToSharedSourceNexiopayPutRequest() *shared.SourceNexiopayPutRequest {
	var name string
	name = r.Name.ValueString()

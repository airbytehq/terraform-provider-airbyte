...
This connection will not sync automatically by default. See the [`airbyte_connection` resource documentation](../resources/connection) for scheduling and other configuration options.

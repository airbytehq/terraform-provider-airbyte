...
- `field_filtering` (Attributes) (see [below for nested schema](#nestedatt--data--configurations--streams--mappers--mapper_configuration--field_filtering))
...
<a id="nestedatt--data--configurations--streams--mappers--mapper_configuration--field_filtering"></a>
### Nested Schema for `data.configurations.streams.mappers.mapper_configuration.field_filtering`

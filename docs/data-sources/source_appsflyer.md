...
page_title: "airbyte_source_appsflyer Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceAppsflyer DataSource
---

# airbyte_source_appsflyer (Data Source)
...
```terraform
data "airbyte_source_appsflyer" "my_source_appsflyer" {

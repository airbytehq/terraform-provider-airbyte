...
page_title: "airbyte_source_ticktick Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceTicktick DataSource
---

# airbyte_source_ticktick (Data Source)
...
```terraform
data "airbyte_source_ticktick" "my_source_ticktick" {

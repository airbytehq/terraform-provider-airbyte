...
page_title: "airbyte_source_partnerize Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourcePartnerize DataSource
---

# airbyte_source_partnerize (Data Source)
...
```terraform
data "airbyte_source_partnerize" "my_source_partnerize" {

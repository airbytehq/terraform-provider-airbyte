...
page_title: "airbyte_source_airbyte_customer_io_source Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceAirbyteCustomerIoSource DataSource
---

# airbyte_source_airbyte_customer_io_source (Data Source)
...
```terraform
data "airbyte_source_airbyte_customer_io_source" "my_source_airbytecustomeriosource" {

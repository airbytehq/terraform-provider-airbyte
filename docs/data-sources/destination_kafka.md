...
page_title: "airbyte_destination_kafka Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  DestinationKafka DataSource
---

# airbyte_destination_kafka (Data Source)
...
```terraform
data "airbyte_destination_kafka" "my_destination_kafka" {

...
page_title: "airbyte_source_firebase_realtime_database Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceFirebaseRealtimeDatabase DataSource
---

# airbyte_source_firebase_realtime_database (Data Source)
...
```terraform
data "airbyte_source_firebase_realtime_database" "my_source_firebaserealtimedatabase" {

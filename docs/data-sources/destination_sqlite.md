...
page_title: "airbyte_destination_sqlite Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  DestinationSqlite DataSource
---

# airbyte_destination_sqlite (Data Source)
...
```terraform
data "airbyte_destination_sqlite" "my_destination_sqlite" {

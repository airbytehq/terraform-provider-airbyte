...
page_title: "airbyte_source_dolibarr Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceDolibarr DataSource
---

# airbyte_source_dolibarr (Data Source)
...
```terraform
data "airbyte_source_dolibarr" "my_source_dolibarr" {

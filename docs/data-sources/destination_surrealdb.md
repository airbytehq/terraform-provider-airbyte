...
page_title: "airbyte_destination_surrealdb Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  DestinationSurrealdb DataSource
---

# airbyte_destination_surrealdb (Data Source)
...
```terraform
data "airbyte_destination_surrealdb" "my_destination_surrealdb" {

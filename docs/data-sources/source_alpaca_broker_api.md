...
page_title: "airbyte_source_alpaca_broker_api Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceAlpacaBrokerAPI DataSource
---

# airbyte_source_alpaca_broker_api (Data Source)
...
```terraform
data "airbyte_source_alpaca_broker_api" "my_source_alpacabrokerapi" {

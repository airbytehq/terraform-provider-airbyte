...
page_title: "airbyte_source_judge_me_reviews Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceJudgeMeReviews DataSource
---

# airbyte_source_judge_me_reviews (Data Source)
...
```terraform
data "airbyte_source_judge_me_reviews" "my_source_judgemereviews" {

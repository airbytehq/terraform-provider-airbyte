...
page_title: "airbyte_source_customerly Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceCustomerly DataSource
---

# airbyte_source_customerly (Data Source)
...
```terraform
data "airbyte_source_customerly" "my_source_customerly" {

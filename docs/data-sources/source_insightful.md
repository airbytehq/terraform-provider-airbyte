...
page_title: "airbyte_source_insightful Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceInsightful DataSource
---

# airbyte_source_insightful (Data Source)
...
```terraform
data "airbyte_source_insightful" "my_source_insightful" {

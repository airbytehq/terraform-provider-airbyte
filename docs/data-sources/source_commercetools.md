...
page_title: "airbyte_source_commercetools Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceCommercetools DataSource
---

# airbyte_source_commercetools (Data Source)
...
```terraform
data "airbyte_source_commercetools" "my_source_commercetools" {

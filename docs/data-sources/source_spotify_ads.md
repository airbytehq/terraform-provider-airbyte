...
page_title: "airbyte_source_spotify_ads Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceSpotifyAds DataSource
---

# airbyte_source_spotify_ads (Data Source)
...
```terraform
data "airbyte_source_spotify_ads" "my_source_spotifyads" {

...
page_title: "airbyte_source_shutterstock Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceShutterstock DataSource
---

# airbyte_source_shutterstock (Data Source)
...
```terraform
data "airbyte_source_shutterstock" "my_source_shutterstock" {

...
page_title: "airbyte_source_netsuite_enterprise Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceNetsuiteEnterprise DataSource
---

# airbyte_source_netsuite_enterprise (Data Source)
...
```terraform
data "airbyte_source_netsuite_enterprise" "my_source_netsuiteenterprise" {

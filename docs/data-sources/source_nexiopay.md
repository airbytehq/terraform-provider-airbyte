...
page_title: "airbyte_source_nexiopay Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceNexiopay DataSource
---

# airbyte_source_nexiopay (Data Source)
...
```terraform
data "airbyte_source_nexiopay" "my_source_nexiopay" {

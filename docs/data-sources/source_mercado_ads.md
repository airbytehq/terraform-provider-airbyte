...
page_title: "airbyte_source_mercado_ads Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceMercadoAds DataSource
---

# airbyte_source_mercado_ads (Data Source)
...
```terraform
data "airbyte_source_mercado_ads" "my_source_mercadoads" {

...
page_title: "airbyte_source_boldsign Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceBoldsign DataSource
---

# airbyte_source_boldsign (Data Source)
...
```terraform
data "airbyte_source_boldsign" "my_source_boldsign" {

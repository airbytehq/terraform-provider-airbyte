...
page_title: "airbyte_source_commcare Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceCommcare DataSource
---

# airbyte_source_commcare (Data Source)
...
```terraform
data "airbyte_source_commcare" "my_source_commcare" {

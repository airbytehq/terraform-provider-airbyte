...
page_title: "airbyte_source_oracle_enterprise Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceOracleEnterprise DataSource
---

# airbyte_source_oracle_enterprise (Data Source)
...
```terraform
data "airbyte_source_oracle_enterprise" "my_source_oracleenterprise" {

...
page_title: "airbyte_source_metricool Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceMetricool DataSource
---

# airbyte_source_metricool (Data Source)
...
```terraform
data "airbyte_source_metricool" "my_source_metricool" {

...
page_title: "airbyte_source_tplcentral Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceTplcentral DataSource
---

# airbyte_source_tplcentral (Data Source)
...
```terraform
data "airbyte_source_tplcentral" "my_source_tplcentral" {

...
page_title: "airbyte_source_nexus_datasets Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceNexusDatasets DataSource
---

# airbyte_source_nexus_datasets (Data Source)
...
```terraform
data "airbyte_source_nexus_datasets" "my_source_nexusdatasets" {

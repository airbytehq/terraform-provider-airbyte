...
page_title: "airbyte_source_watchmode Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceWatchmode DataSource
---

# airbyte_source_watchmode (Data Source)
...
```terraform
data "airbyte_source_watchmode" "my_source_watchmode" {

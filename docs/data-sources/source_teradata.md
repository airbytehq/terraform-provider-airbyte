...
page_title: "airbyte_source_teradata Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceTeradata DataSource
---

# airbyte_source_teradata (Data Source)
...
```terraform
data "airbyte_source_teradata" "my_source_teradata" {

...
page_title: "airbyte_destination_ragie Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  DestinationRagie DataSource
---

# airbyte_destination_ragie (Data Source)
...
```terraform
data "airbyte_destination_ragie" "my_destination_ragie" {

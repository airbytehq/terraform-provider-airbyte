...
page_title: "airbyte_source_couchbase Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceCouchbase DataSource
---

# airbyte_source_couchbase (Data Source)
...
```terraform
data "airbyte_source_couchbase" "my_source_couchbase" {

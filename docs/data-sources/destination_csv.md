...
page_title: "airbyte_destination_csv Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  DestinationCsv DataSource
---

# airbyte_destination_csv (Data Source)
...
```terraform
data "airbyte_destination_csv" "my_destination_csv" {

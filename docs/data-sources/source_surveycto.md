...
page_title: "airbyte_source_surveycto Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceSurveycto DataSource
---

# airbyte_source_surveycto (Data Source)
...
```terraform
data "airbyte_source_surveycto" "my_source_surveycto" {

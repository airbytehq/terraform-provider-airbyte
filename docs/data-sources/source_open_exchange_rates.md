...
page_title: "airbyte_source_open_exchange_rates Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceOpenExchangeRates DataSource
---

# airbyte_source_open_exchange_rates (Data Source)
...
```terraform
data "airbyte_source_open_exchange_rates" "my_source_openexchangerates" {

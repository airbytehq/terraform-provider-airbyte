...
page_title: "airbyte_destination_local_json Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  DestinationLocalJSON DataSource
---

# airbyte_destination_local_json (Data Source)
...
```terraform
data "airbyte_destination_local_json" "my_destination_localjson" {

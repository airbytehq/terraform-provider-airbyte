...
page_title: "airbyte_source_singlestore Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceSinglestore DataSource
---

# airbyte_source_singlestore (Data Source)
...
```terraform
data "airbyte_source_singlestore" "my_source_singlestore" {

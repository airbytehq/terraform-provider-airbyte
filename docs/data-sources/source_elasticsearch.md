...
page_title: "airbyte_source_elasticsearch Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceElasticsearch DataSource
---

# airbyte_source_elasticsearch (Data Source)
...
```terraform
data "airbyte_source_elasticsearch" "my_source_elasticsearch" {

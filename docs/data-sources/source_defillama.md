...
page_title: "airbyte_source_defillama Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceDefillama DataSource
---

# airbyte_source_defillama (Data Source)
...
```terraform
data "airbyte_source_defillama" "my_source_defillama" {

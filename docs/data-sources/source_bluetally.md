...
page_title: "airbyte_source_bluetally Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceBluetally DataSource
---

# airbyte_source_bluetally (Data Source)
...
```terraform
data "airbyte_source_bluetally" "my_source_bluetally" {

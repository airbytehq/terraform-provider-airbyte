...
page_title: "airbyte_source_sap_hana_enterprise Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceSapHanaEnterprise DataSource
---

# airbyte_source_sap_hana_enterprise (Data Source)
...
```terraform
data "airbyte_source_sap_hana_enterprise" "my_source_saphanaenterprise" {

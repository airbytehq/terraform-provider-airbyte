...
page_title: "airbyte_source_jamf_pro Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceJamfPro DataSource
---

# airbyte_source_jamf_pro (Data Source)
...
```terraform
data "airbyte_source_jamf_pro" "my_source_jamfpro" {

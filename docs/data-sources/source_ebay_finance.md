...
page_title: "airbyte_source_ebay_finance Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceEbayFinance DataSource
---

# airbyte_source_ebay_finance (Data Source)
...
```terraform
data "airbyte_source_ebay_finance" "my_source_ebayfinance" {

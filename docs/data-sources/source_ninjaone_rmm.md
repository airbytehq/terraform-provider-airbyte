...
page_title: "airbyte_source_ninjaone_rmm Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceNinjaoneRmm DataSource
---

# airbyte_source_ninjaone_rmm (Data Source)
...
```terraform
data "airbyte_source_ninjaone_rmm" "my_source_ninjaonermm" {

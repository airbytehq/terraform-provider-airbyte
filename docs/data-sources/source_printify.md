...
page_title: "airbyte_source_printify Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourcePrintify DataSource
---

# airbyte_source_printify (Data Source)
...
```terraform
data "airbyte_source_printify" "my_source_printify" {

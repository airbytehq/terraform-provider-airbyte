...
page_title: "airbyte_source_churnkey Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceChurnkey DataSource
---

# airbyte_source_churnkey (Data Source)
...
```terraform
data "airbyte_source_churnkey" "my_source_churnkey" {

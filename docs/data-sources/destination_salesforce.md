...
page_title: "airbyte_destination_salesforce Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  DestinationSalesforce DataSource
---

# airbyte_destination_salesforce (Data Source)
...
```terraform
data "airbyte_destination_salesforce" "my_destination_salesforce" {

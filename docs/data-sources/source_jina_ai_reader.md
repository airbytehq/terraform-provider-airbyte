...
page_title: "airbyte_source_jina_ai_reader Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceJinaAiReader DataSource
---

# airbyte_source_jina_ai_reader (Data Source)
...
```terraform
data "airbyte_source_jina_ai_reader" "my_source_jinaaireader" {

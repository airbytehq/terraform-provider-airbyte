...
page_title: "airbyte_source_airbyte_harness_source Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceAirbyteHarnessSource DataSource
---

# airbyte_source_airbyte_harness_source (Data Source)
...
```terraform
data "airbyte_source_airbyte_harness_source" "my_source_airbyteharnesssource" {

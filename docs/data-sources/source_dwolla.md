...
page_title: "airbyte_source_dwolla Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceDwolla DataSource
---

# airbyte_source_dwolla (Data Source)
...
```terraform
data "airbyte_source_dwolla" "my_source_dwolla" {

...
page_title: "airbyte_destination_gcs_data_lake Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  DestinationGcsDataLake DataSource
---

# airbyte_destination_gcs_data_lake (Data Source)
...
```terraform
data "airbyte_destination_gcs_data_lake" "my_destination_gcsdatalake" {

...
page_title: "airbyte_destination_glassflow Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  DestinationGlassflow DataSource
---

# airbyte_destination_glassflow (Data Source)
...
```terraform
data "airbyte_destination_glassflow" "my_destination_glassflow" {

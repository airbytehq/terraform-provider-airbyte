...
page_title: "airbyte_destination_chroma Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  DestinationChroma DataSource
---

# airbyte_destination_chroma (Data Source)
...
```terraform
data "airbyte_destination_chroma" "my_destination_chroma" {

...
page_title: "airbyte_source_pagerduty Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourcePagerduty DataSource
---

# airbyte_source_pagerduty (Data Source)
...
```terraform
data "airbyte_source_pagerduty" "my_source_pagerduty" {

...
page_title: "airbyte_source_opuswatch Data Source - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceOpuswatch DataSource
---

# airbyte_source_opuswatch (Data Source)
...
```terraform
data "airbyte_source_opuswatch" "my_source_opuswatch" {

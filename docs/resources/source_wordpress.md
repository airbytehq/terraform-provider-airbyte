...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "c71d6f95-a912-432b-ad96-73ded4be7b9c"; Requires replacement if changed.

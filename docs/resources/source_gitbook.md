...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "d1fcdf3a-dcfd-4b2e-a32c-d8a7a2e9790c"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_gitbook.my_airbyte_source_gitbook
  id = "..."
}
```

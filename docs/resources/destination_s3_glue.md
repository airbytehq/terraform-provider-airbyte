...
- `definition_id` (String) The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Default: "471e5cab-8ed1-49f3-ba11-79c687784737"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_destination_s3_glue.my_airbyte_destination_s3_glue
  id = "..."
}
```

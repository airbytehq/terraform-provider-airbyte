...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "ff48bf15-f917-4fff-ba28-cbab56ef892f"; Requires replacement if changed.

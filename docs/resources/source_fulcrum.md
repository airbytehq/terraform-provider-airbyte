...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "1028d4dc-005b-484b-9164-5a81e0dbac19"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_fulcrum.my_airbyte_source_fulcrum
  id = "..."
}
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "a20aa64a-bb59-4782-97bf-afd6a241c737"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_algolia.my_airbyte_source_algolia
  id = "..."
}
```

...
page_title: "airbyte_source_ninjaone_rmm Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceNinjaoneRmm Resource
---

# airbyte_source_ninjaone_rmm (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "49897212-53be-4898-ba2e-b73e72d645ef"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_ninjaone_rmm.my_airbyte_source_ninjaone_rmm
  id = "..."
}
```

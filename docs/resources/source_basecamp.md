...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "0abc340d-772c-4fa1-8d1d-ebf3be72ab51"; Requires replacement if changed.

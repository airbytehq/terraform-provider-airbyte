...
page_title: "airbyte_source_stigg Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceStigg Resource
---

# airbyte_source_stigg (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "c3c0a577-29d7-4e31-8191-f2a346051c82"; Requires replacement if changed.
...
```shell
terraform import airbyte_source_stigg.my_airbyte_source_stigg "..."
```

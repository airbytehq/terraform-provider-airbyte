...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "7c37685e-8512-4901-addf-9afbef6c0de9"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_breezometer.my_airbyte_source_breezometer
  id = "..."
}
```

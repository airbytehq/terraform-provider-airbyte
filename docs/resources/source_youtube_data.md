...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "743a2a44-fd13-4109-a8fe-fb0e68f467f5"; Requires replacement if changed.
...
- `google_o_auth20` (Attributes) (see [below for nested schema](#nestedatt--configuration--credentials--google_o_auth20))
...
### Nested Schema for `configuration.credentials.google_o_auth20`

...
page_title: "airbyte_source_thinkific_courses Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceThinkificCourses Resource
---

# airbyte_source_thinkific_courses (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "f3ef5282-1829-4e1d-a12e-2a637c393884"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_thinkific_courses.my_airbyte_source_thinkific_courses
  id = "..."
}
```
...
```shell
terraform import airbyte_source_thinkific_courses.my_airbyte_source_thinkific_courses "..."
```

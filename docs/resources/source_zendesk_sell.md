...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "982eaa4c-bba1-4cce-a971-06a41f700b8c"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_zendesk_sell.my_airbyte_source_zendesk_sell
  id = "..."
}
```

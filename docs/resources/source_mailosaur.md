...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "251ed5c8-a927-4fb4-ad45-75393d564f3c"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_mailosaur.my_airbyte_source_mailosaur
  id = "..."
}
```

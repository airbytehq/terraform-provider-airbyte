...
page_title: "airbyte_source_bluetally Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceBluetally Resource
---

# airbyte_source_bluetally (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "d4154c0b-7737-42c3-92dc-7a8e046e6456"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_bluetally.my_airbyte_source_bluetally
  id = "..."
}
```

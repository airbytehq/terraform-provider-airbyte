...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "3db8a652-88f7-41ee-91a3-2f745322d9ae"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_cal_com.my_airbyte_source_cal_com
  id = "..."
}
```

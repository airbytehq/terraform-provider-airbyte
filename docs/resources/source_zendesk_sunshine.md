...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "325e0640-e7b3-4e24-b823-3361008f603f"; Requires replacement if changed.
...
- `api_token` (String, Sensitive) The value of the API token generated. See the <a href="https://docs.airbyte.com/integrations/sources/zendesk-sunshine">docs</a> for more information.

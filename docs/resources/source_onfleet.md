...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "e4285e7f-ee6c-4b8b-b231-746c9640164e"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_onfleet.my_airbyte_source_onfleet
  id = "..."
}
```

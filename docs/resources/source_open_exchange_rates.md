...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "77d5ca6b-d345-4dce-ba1e-1935a75778b8"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_open_exchange_rates.my_airbyte_source_open_exchange_rates
  id = "..."
}
```

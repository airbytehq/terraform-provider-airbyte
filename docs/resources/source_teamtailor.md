...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "6d811b1b-5b94-4d5a-a74a-c2e46e5cb87c"; Requires replacement if changed.

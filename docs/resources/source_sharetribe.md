...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "efe368ce-cd19-4be4-a2b1-11c69dc6bffb"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_sharetribe.my_airbyte_source_sharetribe
  id = "..."
}
```

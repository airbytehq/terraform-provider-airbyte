...
page_title: "airbyte_source_shopwired Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceShopwired Resource
---

# airbyte_source_shopwired (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "41b34d94-1704-48b0-b921-cb3009ae69c1"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_shopwired.my_airbyte_source_shopwired
  id = "..."
}
```
...
```shell
terraform import airbyte_source_shopwired.my_airbyte_source_shopwired "..."
```

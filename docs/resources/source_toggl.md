...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "7e7c844f-2300-4342-b7d3-6dd7992593cd"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_toggl.my_airbyte_source_toggl
  id = "..."
}
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "740eadea-6f7a-49dc-a2e6-bdf935a79996"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_missive.my_airbyte_source_missive
  id = "..."
}
```

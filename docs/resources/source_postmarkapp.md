...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "cde75ca1-1e28-4a0f-85bb-90c546de9f1f"; Requires replacement if changed.

...
- `inference_type` (String) How to infer the types of the columns. If none, inference default to strings. Default: "None"; must be one of ["None", "Primitive Types Only"]

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "4c3d6bdd-dc0e-4a66-b48a-2e7956195eec"; Requires replacement if changed.

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "7fbeaeea-2d0d-4f13-8200-fa228494d91c"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_clarif_ai.my_airbyte_source_clarif_ai
  id = "..."
}
```

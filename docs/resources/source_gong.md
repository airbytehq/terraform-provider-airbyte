...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "32382e40-3b49-4b99-9c5c-4076501914e7"; Requires replacement if changed.
...
- `credentials` (Attributes) Choose how to authenticate to Gong. (see [below for nested schema](#nestedatt--configuration--credentials))
...
- `authenticate_via_gong_o_auth` (Attributes) (see [below for nested schema](#nestedatt--configuration--credentials--authenticate_via_gong_o_auth))
- `authenticate_with_api_key` (Attributes) (see [below for nested schema](#nestedatt--configuration--credentials--authenticate_with_api_key))

<a id="nestedatt--configuration--credentials--authenticate_via_gong_o_auth"></a>
### Nested Schema for `configuration.credentials.authenticate_via_gong_o_auth`
...
<a id="nestedatt--configuration--credentials--authenticate_with_api_key"></a>
### Nested Schema for `configuration.credentials.authenticate_with_api_key`

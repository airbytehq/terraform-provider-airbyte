...
page_title: "airbyte_source_printify Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourcePrintify Resource
---

# airbyte_source_printify (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "55c7d816-ff5e-48a1-9928-acaba4243aa9"; Requires replacement if changed.
...
```shell
terraform import airbyte_source_printify.my_airbyte_source_printify "..."
```

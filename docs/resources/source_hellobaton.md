...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "492b56d1-937c-462e-8076-21ad2031e784"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_hellobaton.my_airbyte_source_hellobaton
  id = "..."
}
```

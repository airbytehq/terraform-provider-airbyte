...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "488cdc64-36cd-451d-bcfa-c6478b461e94"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_justcall.my_airbyte_source_justcall
  id = "..."
}
```

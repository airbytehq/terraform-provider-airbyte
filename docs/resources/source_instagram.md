...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "6acf6b55-4f1e-4fca-944e-1a3caef8aba8"; Requires replacement if changed.

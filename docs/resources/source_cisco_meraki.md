...
page_title: "airbyte_source_cisco_meraki Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceCiscoMeraki Resource
---

# airbyte_source_cisco_meraki (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "65468f53-6682-4fa4-8627-1dfa4b3dc560"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_cisco_meraki.my_airbyte_source_cisco_meraki
  id = "..."
}
```
...
```shell
terraform import airbyte_source_cisco_meraki.my_airbyte_source_cisco_meraki "..."
```

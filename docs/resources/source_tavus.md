...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "f2889d35-753f-4106-bce5-8a865bc339a6"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_tavus.my_airbyte_source_tavus
  id = "..."
}
```

...
page_title: "airbyte_source_churnkey Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceChurnkey Resource
---

# airbyte_source_churnkey (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "0f1a0659-0239-48a7-bf34-072a5bf2713a"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_churnkey.my_airbyte_source_churnkey
  id = "..."
}
```
...
```shell
terraform import airbyte_source_churnkey.my_airbyte_source_churnkey "..."
```

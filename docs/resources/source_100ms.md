...
page_title: "airbyte_source_100ms Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  Source100ms Resource
---

# airbyte_source_100ms (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "41bf83df-e5e4-44e3-b9c0-6933a26a4410"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_100ms.my_airbyte_source_100ms
  id = "..."
}
```

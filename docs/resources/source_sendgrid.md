...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "fbb5fbe2-16ad-4cf4-af7d-ff9d9c316c87"; Requires replacement if changed.

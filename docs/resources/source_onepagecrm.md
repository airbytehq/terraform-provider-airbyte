...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "d59cce29-baa8-4202-b1ca-a4759c20c908"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_onepagecrm.my_airbyte_source_onepagecrm
  id = "..."
}
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "71607ba1-c0ac-4799-8049-7f4b90dd50f7"; Requires replacement if changed.
...
- `read_empty_header_columns` (Boolean) When enabled, the connector will continue reading columns after empty header cells and will include data from those columns using generated column names (e.g., "column_C"). By default, the connector stops reading columns when it encounters an empty header cell. Default: false

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "d30fb809-6456-484d-8e2c-ee12e0f6888d"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_partnerstack.my_airbyte_source_partnerstack
  id = "..."
}
```

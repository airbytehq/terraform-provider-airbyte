...
page_title: "airbyte_source_acuity_scheduling Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceAcuityScheduling Resource
---

# airbyte_source_acuity_scheduling (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "bc7db25c-bdfb-4ec2-96ae-a4687cead916"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_acuity_scheduling.my_airbyte_source_acuity_scheduling
  id = "..."
}
```
...
```shell
terraform import airbyte_source_acuity_scheduling.my_airbyte_source_acuity_scheduling "..."
```

...
page_title: "airbyte_source_customerly Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceCustomerly Resource
---

# airbyte_source_customerly (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "5a48749a-84ee-4a4e-8e84-217119fbe438"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_customerly.my_airbyte_source_customerly
  id = "..."
}
```

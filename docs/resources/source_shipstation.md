...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "c5a0d24d-5587-4425-ab28-b8b3fe741c78"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_shipstation.my_airbyte_source_shipstation
  id = "..."
}
```

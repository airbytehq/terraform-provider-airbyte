...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "6e87d8e2-47bc-4a0a-a175-62e2b926bb07"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_ruddr.my_airbyte_source_ruddr
  id = "..."
}
```

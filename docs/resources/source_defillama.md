...
page_title: "airbyte_source_defillama Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceDefillama Resource
---

# airbyte_source_defillama (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "df19571f-208a-4a12-a402-a4cdf70a44d6"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_defillama.my_airbyte_source_defillama
  id = "..."
}
```
...
```shell
terraform import airbyte_source_defillama.my_airbyte_source_defillama "..."
```

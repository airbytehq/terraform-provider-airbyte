...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "63df2e59-d086-4980-af83-01948325eacd"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_mixmax.my_airbyte_source_mixmax
  id = "..."
}
```

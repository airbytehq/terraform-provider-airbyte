...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "dc3b9003-2432-4e93-a7f4-4620b0f14674"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_mailerlite.my_airbyte_source_mailerlite
  id = "..."
}
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "948f3a37-f80b-4f57-a918-9fd733f7a018"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_mode.my_airbyte_source_mode
  id = "..."
}
```

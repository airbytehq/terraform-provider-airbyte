...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "2e731a08-e503-4caf-998a-92bd4afd80c1"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_systeme.my_airbyte_source_systeme
  id = "..."
}
```

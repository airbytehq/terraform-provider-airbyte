...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "9fdc3733-c51a-4129-9be5-7e9ad6eab6ac"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_gorgias.my_airbyte_source_gorgias
  id = "..."
}
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "100640bc-c2f3-42b2-a91a-8164f7499ec3"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_freshchat.my_airbyte_source_freshchat
  id = "..."
}
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "379fc8e8-c6ec-4c13-90cb-dfebb536fac6"; Requires replacement if changed.

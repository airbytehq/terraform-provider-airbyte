...
page_title: "airbyte_source_nebius_ai Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceNebiusAi Resource
---

# airbyte_source_nebius_ai (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "dcbc009d-151c-4130-96d7-6734205ac5b7"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_nebius_ai.my_airbyte_source_nebius_ai
  id = "..."
}
```

...
page_title: "airbyte_source_airbyte_customer_io_source Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceAirbyteCustomerIoSource Resource
---

# airbyte_source_airbyte_customer_io_source (Resource)
...
```terraform
import {
  to = airbyte_source_airbyte_customer_io_source.my_airbyte_source_airbyte_customer_io_source
  id = "..."
}
```
...
```shell
terraform import airbyte_source_airbyte_customer_io_source.my_airbyte_source_airbyte_customer_io_source "..."
```

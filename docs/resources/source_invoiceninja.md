...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "7aa7e05d-6bba-463e-b635-cd3b96d40101"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_invoiceninja.my_airbyte_source_invoiceninja
  id = "..."
}
```

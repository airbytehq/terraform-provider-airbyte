...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "8ac02323-03a3-4026-96f0-68573237c49a"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_nutshell.my_airbyte_source_nutshell
  id = "..."
}
```

...
page_title: "airbyte_source_grafana Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceGrafana Resource
---

# airbyte_source_grafana (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "bdf17de3-a522-4929-ab63-0205f794f7b4"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_grafana.my_airbyte_source_grafana
  id = "..."
}
```
...
```shell
terraform import airbyte_source_grafana.my_airbyte_source_grafana "..."
```

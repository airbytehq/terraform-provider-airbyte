...
page_title: "airbyte_source_harness Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceHarness Resource
---

# airbyte_source_harness (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "b0e46f61-e143-47cc-a595-4bb73bfa8a15"; Requires replacement if changed.
...
- `api_url` (String) The API URL for fetching data from Harness. Default: "https://app.harness.io"
...
```terraform
import {
  to = airbyte_source_harness.my_airbyte_source_harness
  id = "..."
}
```

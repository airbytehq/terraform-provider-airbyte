...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "c9db3f2d-054a-43bc-96cc-0d2843bce018"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_flowlu.my_airbyte_source_flowlu
  id = "..."
}
```

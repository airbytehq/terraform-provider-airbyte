...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "cd803254-3d2c-4613-a870-20d205ee6267"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_chargedesk.my_airbyte_source_chargedesk
  id = "..."
}
```

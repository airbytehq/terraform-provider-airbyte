...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "b928158d-4d2a-4ea6-a9c6-efa90f5c1e5d"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_beamer.my_airbyte_source_beamer
  id = "..."
}
```

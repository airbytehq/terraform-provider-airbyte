...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "d8384215-9de6-4268-bbea-40c636ee14c7"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_sage_hr.my_airbyte_source_sage_hr
  id = "..."
}
```

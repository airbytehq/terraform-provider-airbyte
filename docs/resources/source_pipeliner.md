...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "39fd5da7-5713-446b-a9c6-c695f0352f20"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_pipeliner.my_airbyte_source_pipeliner
  id = "..."
}
```

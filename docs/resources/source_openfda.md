...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "b97d588f-d49f-440c-9158-9dd33c59fd26"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_openfda.my_airbyte_source_openfda
  id = "..."
}
```

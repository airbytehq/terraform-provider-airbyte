...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "6ad23bfc-cb11-4faa-a243-f9ccdb0145cc"; Requires replacement if changed.

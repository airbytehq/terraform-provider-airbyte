...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "1e9086ab-ddac-4c1d-aafd-ba43ff575fe4"; Requires replacement if changed.

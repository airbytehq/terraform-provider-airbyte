...
page_title: "airbyte_source_workday_rest Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceWorkdayRest Resource
---

# airbyte_source_workday_rest (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "8d22fb25-a6e8-40e5-9a8b-0e057cc0bb86"; Requires replacement if changed.
...
- `num_workers` (Number) The number of worker threads to use for the sync. Default: 20
...
```terraform
import {
  to = airbyte_source_workday_rest.my_airbyte_source_workday_rest
  id = "..."
}
```
...
```shell
terraform import airbyte_source_workday_rest.my_airbyte_source_workday_rest "..."
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "30ccdb61-445d-480b-8b76-8f09348f8bb9"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_tinyemail.my_airbyte_source_tinyemail
  id = "..."
}
```

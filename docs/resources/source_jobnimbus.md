...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "0b98589b-ccee-40fd-9e9d-28d94087b4e1"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_jobnimbus.my_airbyte_source_jobnimbus
  id = "..."
}
```

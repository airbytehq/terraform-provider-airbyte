...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "34f697bc-b989-4eda-b06f-d0f39b88825b"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_customer_io.my_airbyte_source_customer_io
  id = "..."
}
```

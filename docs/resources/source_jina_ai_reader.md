...
page_title: "airbyte_source_jina_ai_reader Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceJinaAiReader Resource
---

# airbyte_source_jina_ai_reader (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "47077a7f-7ab0-47ee-b428-650396a708c7"; Requires replacement if changed.
...
- `search_prompt` (String) Default: "Search%20airbyte"
...
```terraform
import {
  to = airbyte_source_jina_ai_reader.my_airbyte_source_jina_ai_reader
  id = "..."
}
```
...
```shell
terraform import airbyte_source_jina_ai_reader.my_airbyte_source_jina_ai_reader "..."
```

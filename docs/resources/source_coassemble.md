...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "85999b05-fae0-4312-a3ae-f4987f50d434"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_coassemble.my_airbyte_source_coassemble
  id = "..."
}
```

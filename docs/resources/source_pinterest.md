...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "5cb7e5fe-38c2-11ec-8d3d-0242ac130003"; Requires replacement if changed.
...
- `num_threads` (Number) The number of parallel threads to use for the sync. Default: 2
...
- `attribution_types` (List of String) List of types of attribution for the conversion report. Default: ["INDIVIDUAL","HOUSEHOLD"]

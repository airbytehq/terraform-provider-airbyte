...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "54664ae8-39aa-467f-9703-9b343ee23b9b"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_keka.my_airbyte_source_keka
  id = "..."
}
```

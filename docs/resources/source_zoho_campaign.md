...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "1d0d5605-604b-401a-8a69-92f841a95a90"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_zoho_campaign.my_airbyte_source_zoho_campaign
  id = "..."
}
```

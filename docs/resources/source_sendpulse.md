...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "ae2d64c4-8282-4a44-9e0d-be29c42e558c"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_sendpulse.my_airbyte_source_sendpulse
  id = "..."
}
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "6babfc42-c734-4ef6-a817-6eca15f0f9b7"; Requires replacement if changed.

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "5db8292c-5f5a-11ed-9b6a-0242ac120002"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_weatherstack.my_airbyte_source_weatherstack
  id = "..."
}
```

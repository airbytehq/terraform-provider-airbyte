...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "786c6867-8a22-4e5f-a605-0a59dc3ea00f"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_payfit.my_airbyte_source_payfit
  id = "..."
}
```

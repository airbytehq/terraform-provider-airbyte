...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "a8b458a3-024f-430e-8f62-a200c3eb79fd"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_7shifts.my_airbyte_source_7shifts
  id = "..."
}
```

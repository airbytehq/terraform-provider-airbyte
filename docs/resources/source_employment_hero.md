...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "e2db518e-ef68-40bb-a2b6-b9f9aabbadb3"; Requires replacement if changed.

...
page_title: "airbyte_source_aviationstack Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceAviationstack Resource
---

# airbyte_source_aviationstack (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "874cbc8d-6b04-4da6-9f88-881da2b0febe"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_aviationstack.my_airbyte_source_aviationstack
  id = "..."
}
```
...
```shell
terraform import airbyte_source_aviationstack.my_airbyte_source_aviationstack "..."
```

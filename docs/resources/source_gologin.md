...
page_title: "airbyte_source_gologin Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceGologin Resource
---

# airbyte_source_gologin (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "02e5177c-84cf-424c-91e4-9f7ce344b813"; Requires replacement if changed.
...
```shell
terraform import airbyte_source_gologin.my_airbyte_source_gologin "..."
```

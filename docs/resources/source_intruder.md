...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "3d15163b-11d8-412f-b808-795c9b2c3a3a"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_intruder.my_airbyte_source_intruder
  id = "..."
}
```

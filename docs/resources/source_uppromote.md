...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "d75a7792-e5db-4645-93c3-b4a16ad62ab0"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_uppromote.my_airbyte_source_uppromote
  id = "..."
}
```

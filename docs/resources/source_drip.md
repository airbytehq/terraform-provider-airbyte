...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "4221175d-1bb9-436d-8cc7-ca0d8605b2b6"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_drip.my_airbyte_source_drip
  id = "..."
}
```

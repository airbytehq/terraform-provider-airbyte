...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "c8f77358-755a-4778-a1fc-c23c3cee7d83"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_statsig.my_airbyte_source_statsig
  id = "..."
}
```

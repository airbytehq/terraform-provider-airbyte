...
page_title: "airbyte_source_watchmode Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceWatchmode Resource
---

# airbyte_source_watchmode (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "c10bae9d-398b-480a-a49b-5ae69cdc0759"; Requires replacement if changed.
...
- `search_val` (String) The name value for search stream. Default: "Terminator"
...
```terraform
import {
  to = airbyte_source_watchmode.my_airbyte_source_watchmode
  id = "..."
}
```

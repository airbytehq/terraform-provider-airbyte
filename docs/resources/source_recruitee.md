...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "3b046ac7-d8d3-4eb3-b122-f96b2a16d8a8"; Requires replacement if changed.

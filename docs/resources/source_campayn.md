...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "5674ae5a-511e-4093-9da9-086bf5f0b568"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_campayn.my_airbyte_source_campayn
  id = "..."
}
```

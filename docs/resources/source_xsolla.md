...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "6ff73a16-05a8-4f7e-8771-5433764678f1"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_xsolla.my_airbyte_source_xsolla
  id = "..."
}
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "ed2c12aa-375c-4d18-9d3b-7e1f8a23245d"; Requires replacement if changed.

...
page_title: "airbyte_source_poplar Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourcePoplar Resource
---

# airbyte_source_poplar (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "2d9f2646-1e32-4336-abbe-7e5e113b479e"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_poplar.my_airbyte_source_poplar
  id = "..."
}
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "ab49ae02-a22d-4c9a-b0be-f260e61a4011"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_testrail.my_airbyte_source_testrail
  id = "..."
}
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "d12ba86d-e393-4269-a6b7-4eddcba98eb4"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_repairshopr.my_airbyte_source_repairshopr
  id = "..."
}
```

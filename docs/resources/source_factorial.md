...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "02e8708f-3270-4f13-8b67-257b8ef439f0"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_factorial.my_airbyte_source_factorial
  id = "..."
}
```

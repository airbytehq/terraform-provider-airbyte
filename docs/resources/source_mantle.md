...
page_title: "airbyte_source_mantle Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceMantle Resource
---

# airbyte_source_mantle (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "da48299b-4afa-46b4-bb9d-e1ade37e7169"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_mantle.my_airbyte_source_mantle
  id = "..."
}
```
...
```shell
terraform import airbyte_source_mantle.my_airbyte_source_mantle "..."
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "7408d324-0442-488c-95e3-9d3ec1d3cf59"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_katana.my_airbyte_source_katana
  id = "..."
}
```

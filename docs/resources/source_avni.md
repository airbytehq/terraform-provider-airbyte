...
page_title: "airbyte_source_avni Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceAvni Resource
---

# airbyte_source_avni (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "5d297ac7-355e-4a04-be75-a5e7e175fc4e"; Requires replacement if changed.
...
- `start_date` (String) Specify Date and time from which you want to fetch data. Default: "2000-06-23T01:30:00.000Z"
...
```terraform
import {
  to = airbyte_source_avni.my_airbyte_source_avni
  id = "..."
}
```
...
```shell
terraform import airbyte_source_avni.my_airbyte_source_avni "..."
```

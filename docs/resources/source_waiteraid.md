...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "03a53b13-794a-4d6b-8544-3b36ed8f3ce4"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_waiteraid.my_airbyte_source_waiteraid
  id = "..."
}
```

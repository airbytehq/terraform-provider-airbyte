...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "7bdf5aaa-3dad-4ed0-9cec-4858454f3e18"; Requires replacement if changed.

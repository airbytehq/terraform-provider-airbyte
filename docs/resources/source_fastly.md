...
page_title: "airbyte_source_fastly Resource - terraform-provider-airbyte"
subcategory: ""
description: |-
  SourceFastly Resource
---

# airbyte_source_fastly (Resource)
...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "d14ff3ed-5049-4dfb-bc28-1d7ccaf67182"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_fastly.my_airbyte_source_fastly
  id = "..."
}
```

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "d1aa448b-7c54-498e-ad95-263cbebcd2db"; Requires replacement if changed.

...
- `definition_id` (String) The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Default: "a2e34f7c-7de1-422c-b909-ce12f3e051af"; Requires replacement if changed.
...
```terraform
import {
  to = airbyte_source_hoorayhr.my_airbyte_source_hoorayhr
  id = "..."
}
```
